...
function ForecastSection({K,lang='en'}){
  ...
  const todayK=React.useMemo(()=>computeKundali({year:browserNow.getUTCFullYear(),month:browserNow.getUTCMonth()+1,day:browserNow.getUTCDate(),hour:utcH,minute:utcM,utcOffset:0,lat:K.input.lat,lng:K.input.lng}),[K.input.lat, K.input.lng]);
