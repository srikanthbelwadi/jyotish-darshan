...
function DailyPanchang({ lang }){
    ...
    return (
      <div style={{background:'var(--bg-card)', borderBottom:'1px solid var(--border-light)', padding:'8px 24px', fontSize:11, color:'var(--text-muted)', display:'flex', flexWrap:'wrap', gap:'8px 16px', alignItems:'center', justifyContent:'center', letterSpacing:0.5}}>
