...
hi:{'Gaja Kesari':{name:'गजकेसरी योग',effect:'गुरु-चंद्र संयोग ज्ञान, धन और यश लाता है।'},'Budhaditya':{name:'बुधादित्य योग',effect:'सूर्य-बुध संयोग तीक्ष्ण बुद्धि और संवाद कौशल देता है।'},'Hamsa':{name:'हंस योग',effect:'केंद्र में गुरु ज्ञान और आध्यात्मिक प्रवृत्ति देता है।'},'Malavya':{name:'मालव्य योग',effect:'केंद्र में शुक्र विलासिता और कलात्मक प्रतिभा लाता है।'},'Ruchaka':{name:'रुचक योग',effect:'केंद्र में मंगल साहस और नेतृत्व देता है।'},'Bhadra':{name:'भद्र योग',effect:'केंद्र में बुध वाक्पटुता और बौद्धिक सफलता देता है।'},'Sasa':{name:'शश योग',effect:'केंद्र में शनि अधिकार और संगठन शक्ति देता है।'},'Mangal Dosha':{name:'मंगल दोष',effect:'मंगल विवाह भाव को प्रभावित करता है; उपाय अनुशंसित।'},'Kaal Sarpa':{name:'काल सर्प दोष',effect:'सभी ग्रह राहु-केतु अक्ष में; कार्मिक तीव्रता।'},'Pitru Dosha':{name:'पितृ दोष',effect:'पूर्वजों का कार्मिक ऋण संतान और समृद्धि को प्रभावित करता है।'},'Guru Chandal':{name:'गुरु चांडाल योग',effect:'गुरु-राहु संयोग परंपरागत ज्ञान को चुनौती दे सकता है।'}},'Chandra-Mangal':{name:'ചന്ദ്ര-ചൊവ്വ യോഗം',effect:'ചന്ദ്ര-ചൊവ്വ സംയോഗം സാമ്പത്തിക വൈദഗ്ധ്യം, ധീരമായ മുൻകൈ, വാണിജ്യ വിജയം നൽകുന്നു.'},'Chandra-Mangal':{name:'চন্দ্র-মঙ্গল যোগ',effect:'চন্দ্র-মঙ্গল সংযোগ আর্থিক দক্ষতা, সাহসী উদ্যোগ ও বাণিজ্যিক সাফল্য দেয়.'},'Chandra-Mangal':{name:'ચંદ્ર-મંગળ યોગ',effect:'ચંદ્ર-મંગળ સંયોગ નાણાકીય કુશળતા, સાહસિક પહેલ અને વ્યાપારિક સફળતા આપે છે.'},'Chandra-Mangal':{name:'चंद्र-मंगळ योग',effect:'चंद्र-मंगळ संयोग आर्थिक कुशलता, धाडसी पुढाकार आणि व्यापारी यश देतो.'},'Chandra-Mangal':{name:'चन्द्रमङ्गलयोगः',effect:'चन्द्रमङ्गलसंयोगः वित्तीयकुशलतां साहसिकपहलं वाणिज्यसफलतां च प्रदाति।'},'Chandra-Mangal':{name:'சந்திர-செவ்வாய் யோகம்',effect:'சந்திர-செவ்வாய் சேர்க்கை நிதி திறன், தைரியமான முயற்சி மற்றும் வணிக வெற்றியை அளிக்கிறது.'},'Chandra-Mangal':{name:'చంద్ర-కుజ యోగం',effect:'చంద్ర-కుజ సంయోగం ఆర్థిక నైపుణ్యం, సాహసం మరియు వాణిజ్య విజయాన్ని ఇస్తుంది.'},'Chandra-Mangal':{name:'ಚಂದ್ರ-ಮಂಗಳ ಯೋಗ',effect:'ಚಂದ್ರ-ಮಂಗಳ ಸಂಯೋಗ ಹಣಕಾಸು ಕುಶಲತೆ, ಧೈರ್ಯಶಾಲಿ ಮುಂದಾಳತ್ವ ಮತ್ತು ವ್ಯಾಪಾರ ಯಶಸ್ಸನ್ನು ನೀಡುತ್ತದೆ.'},'Chandra-Mangal':{name:'चंद्र-मंगल योग',effect:'चंद्र-मंगल संयोग वित्तीय कुशलता, साहसी पहल और व्यापारिक सफलता प्रदान करता है।'},'Chandra-Mangal':{name:'Chandra-Mangal Yoga',effect:'Moon-Mars conjunction confers financial acumen, bold initiative, and commercial success.'},
...
te:{'Gaja Kesari':{name:'గజకేసరి యోగం',effect:'గురు-చంద్ర సంయోగం జ్ఞానం, సంపద మరియు కీర్తి తెస్తుంది.'},'Budhaditya':{name:'బుధాదిత్య యోగం',effect:'సూర్య-బుధ సంయోగం తీక్షణ బుద్ధిని ఇస్తుంది.'},'Hamsa':{name:'హంస యోగం',effect:'కేంద్రంలో గురుడు జ్ఞానాన్ని ఇస్తాడు.'},'Malavya':{name:'మాలవ్య యోగం',effect:'కేంద్రంలో శుక్రుడు విలాసాన్ని తెస్తాడు.'},'Ruchaka':{name:'రుచక యోగం',effect:'కేంద్రంలో కుజుడు ధైర్యాన్ని ఇస్తాడు.'},'Bhadra':{name:'భద్ర యోగం',effect:'కేంద్రంలో బుధుడు వాక్పటిమను ఇస్తాడు.'},'Sasa':{name:'శశ యోగం',effect:'కేంద్రంలో శని అధికారాన్ని ఇస్తాడు.'},'Mangal Dosha':{name:'మంగళ దోషం',effect:'కుజుడు వివాహ భావాన్ని ప్రభావితం చేస్తాడు.'},'Kaal Sarpa':{name:'కాల సర్ప దోషం',effect:'అన్ని గ్రహాలు రాహు-కేతు అక్షంలో.'},'Pitru Dosha':{name:'పితృ దోషం',effect:'పూర్వీకుల కార్మిక ఋణం సంతానాన్ని ప్రభావితం చేస్తుంది.'},'Guru Chandal':{name:'గురు చాండాల యోగం',effect:'గురు-రాహు సంయోగం సంప్రదాయ జ్ఞానానికి సవాలు చేయవచ్చు.'}},'Chandra-Mangal':{name:'ചന്ദ്ര-ചൊവ്വ യോഗം',effect:'ചന്ദ്ര-ചൊവ്വ സംയോഗം സാമ്പത്തിക വൈദഗ്ധ്യം, ധീരമായ മുൻകൈ, വാണിജ്യ വിജയം നൽകുന്നു.'},'Chandra-Mangal':{name:'চন্দ্র-মঙ্গল যোগ',effect:'চন্দ্র-মঙ্গল সংযোগ আর্থিক দক্ষতা, সাহসী উদ্যোগ ও বাণিজ্যিক সাফল্য দেয়.'},'Chandra-Mangal':{name:'ચંદ્ર-મંગળ યોગ',effect:'ચંદ્ર-મંગળ સંયોગ નાણાકીય કુશળતા, સાહસિક પહેલ અને વ્યાપારિક સફળતા આપે છે.'},'Chandra-Mangal':{name:'चंद्र-मंगळ योग',effect:'चंद्र-मंगळ संयोग आर्थिक कुशलता, धाडसी पुढाकार आणि व्यापारी यश देतो.'},'Chandra-Mangal':{name:'चन्द्रमङ्गलयोगः',effect:'चन्द्रमङ्गलसंयोगः वित्तीयकुशलतां साहसिकपहलं वाणिज्यसफलतां च प्रदाति।'},'Chandra-Mangal':{name:'சந்திர-செவ்வாய் யோகம்',effect:'சந்திர-செவ்வாய் சேர்க்கை நிதி திறன், தைரியமான முயற்சி மற்றும் வணிக வெற்றியை அளிக்கிறது.'},'Chandra-Mangal':{name:'చంద్ర-కుజ యోగం',effect:'చంద్ర-కుజ సంయోగం ఆర్థిక నైపుణ్యం, సాహసం మరియు వాణిజ్య విజయాన్ని ఇస్తుంది.'},'Chandra-Mangal':{name:'ಚಂದ್ರ-ಮಂಗಳ ಯೋಗ',effect:'ಚಂದ್ರ-ಮಂಗಳ ಸಂಯೋಗ ಹಣಕಾಸು ಕುಶಲತೆ, ಧೈರ್ಯಶಾಲಿ ಮುಂದಾಳತ್ವ ಮತ್ತು ವ್ಯಾಪಾರ ಯಶಸ್ಸನ್ನು ನೀಡುತ್ತದೆ.'},'Chandra-Mangal':{name:'चंद्र-मंगल योग',effect:'चंद्र-मंगल संयोग वित्तीय कुशलता, साहसी पहल और व्यापारिक सफलता प्रदान करता है।'},'Chandra-Mangal':{name:'Chandra-Mangal Yoga',effect:'Moon-Mars conjunction confers financial acumen, bold initiative, and commercial success.'},
...
suggest:{sun:'నాయకత్వం మరియు సేవలో ధైర్యంగా అడుగు వేయండి. సూర్య నమస్కారాలు మేలు.',moon:'సృజనాత్మక అభివ్యక్తి మరియు కుటుంబ బంధాలు భావోద్వేగ ఆరోగ్యాన్ని పోషిస్తాయి.',mars:'శారీరక ఆరోగ్యం మరియు వ్యాపార సాహసాల్లో శక్తిని వినియోగించండి.',mercury:'నేర్చుకోవడం, రాయడం మరియు నైపుణ్య నిర్మాణంలో పెట్టుబడి పెట్టండి.',jupiter:'విద్య, బోధన మరియు దాన కార్యాలలో పాలుపంచుకోండి.',venus:'సంబంధాలు, కళ మరియు సృజనాత్మకతలో పెట్టుబడి పెట్టండి.',saturn:'ఓర్పుతో దీర్ఘకాలిక పునాదులు నిర్మించండి.',rahu:'నవీనత మరియు మార్పులను ధైర్యంగా స్వీకరించండి.',ketu:'ధ్యానం మరియు ఆధ్యాత్మిక అధ్యయనాన్ని లోతుగా చేయండి.'},
overview:(ln,mn,mr,sp,yc)=>`ఈ కుండలి ${ln} లగ్నం మీద ఆధారపడి ఉంది — జాతకుని వ్యక్తిత్వం మరియు జీవన విధానాన్ని రూపొందిస్తోంది. ${mn} నక్షత్రం (${mr})లో చంద్రుడు భావోద్వేగ జగత్తును సున్నితత్వం మరియు అంతర్జ్ఞానంతో నింపుతాడు. ${sp.length>0?sp.join(' మరియు ')+'లో అసాధారణ గ్రహ బలం ప్రవహిస్తోంది.':'గ్రహ శక్తులు విస్తృతంగా వ్యాపించి బహుముఖ వ్యక్తిత్వాన్ని సృష్టిస్తున్నాయి.'} ${yc>0?yc+' రాజ/ధన యోగాలు ఉన్నాయి — గుర్తింపు మరియు సమృద్ధికి అధిక సామర్థ్యం సూచిక.':''}`,
career:(pk,tl,tlh,sp)=>{const t={sun:'ప్రభుత్వం, పరిపాలన, వైద్యం మరియు నాయకత్వం',moon:'ఆతిథ్యం, చికిత్స మరియు ప్రజా సేవ',mars:'ఇంజనీరింగ్, సైన్యం, క్రీడలు మరియు వ్యాపారం',mercury:'సాంకేతికత, వర్తకం, రచన మరియు శిక్షణ',jupiter:'న్యాయం, విద్య, బ్యాంకింగ్ మరియు సలహా',venus:'కళ, ఫ్యాషన్, వినోదం మరియు దౌత్యం',saturn:'పరిశోధన, తయారీ మరియు ప్రభుత్వ సేవ',rahu:'సాంకేతికత, విదేశీ సంబంధాలు మరియు నవీనత',ketu:'పరిశోధన, వైద్యం మరియు ఆధ్యాత్మిక నైపుణ్యం'};return`దశమ భావం ${tl} చేత పరిపాలించబడుతోంది — ${tlh}వ భావంలో — ${t[pk]||'ప్రత్యేక రంగాలలో'} సహజ సామర్థ్యాన్ని సూచిస్తోంది. ${sp.includes('jupiter')?'గురువు బలం వృత్తిలో జ్ఞానం మరియు నైతిక అధికారం చేరుస్తుంది. ':''} ${sp.includes('saturn')?'శని బలం నిరంతర శ్రమ ఫలప్రదం చేస్తుంది. ':''}`.replace(/\s+/g,' ').trim();},
partner:(sl,hm,vc)=>`సప్తమ భావం ${sl} చేత పరిపాలించబడుతోంది. ${hm?'మంగళ దోషం ఉంది — మాంగళిక భాగస్వామి మరియు మంగళ శాంతి అవసరం.':'సంబంధాలు పరస్పర గౌరవం మరియు భాగస్వామ్య లక్ష్యాలపై నిర్మించబడతాయి.'} ${vc==='Strong'?'శుక్రుడు బలంగా ఉన్నాడు — వైవాహిక సుఖం స్పష్టంగా సూచితమైంది.':vc==='Weak'?'సంబంధాలలో కృతజ్ఞత మరియు మనస్ఫూర్తి బెళవడం అభివృద్ధి చేయండి.':'శుక్రుడు నిజమైన ప్రయత్నంతో సంతులిత భాగస్వామ్యాన్ని మద్దతు ఇస్తాడు.'}`,
strengths:(n)=>`${n.join(', ')} ఈ కుండలిలో సహజ బలం మరియు ఆత్మ-స్థాయి నైపుణ్యం యొక్క మూలం. ఇక్కడ ప్రతిభ సహజంగా ప్రవహిస్తుంది.`,
...
const L_FORECAST={
en:{
heading:'Personalized Forecasts',today:'Today',week:'This Week',year:'This Year',
vsLabel:'Vikram Samvat',monthLabel:'Hindu Month',transitMoon:'Transit Moon',
basisLabel:'Astrological Basis',oppLabel:'Opportunities',cautionLabel:'Cautions',guidanceLabel:'Guidance',
sadeSati:{rising:'Sade Sati Rising',peak:'Sade Sati Peak',setting:'Sade Sati Concluding',none:''},
kantaka:'Kantaka Shani Phase',
moonQ:{good:'Auspicious Day',challenging:'Introspective Day',moderate:'Steady Day'},
jupQ:{good:'Jupiter Favourable',challenging:'Jupiter in Challenge',moderate:'Jupiter Balanced'},
moonD:(h,gn,natGn)=>`The Moon transits the ${h}th position from your natal Moon in ${natGn}, now moving through ${gn}. `,
moonGood:(h)=>h===1?'Janma nakshatra returns — a day for intention-setting and inner clarity.':h===3?'Third from natal Moon — communicative, courageous energy. Ideal for conversations and short journeys.':h===6?'Sixth from natal Moon — determined, competitive drive. Tackle challenges head-on today.':h===7?'Seventh from natal Moon — socially harmonious. Partnerships and collaborations are well supported.':h===10?'Tenth from natal Moon — career-forward momentum. Visibility and professional action bring results.':'Eleventh from natal Moon — gains-oriented energy. Networking, financial decisions, and new connections flourish.',
moonChal:'Eighth from natal Moon — a quieter, inward day. Avoid major decisions; rest, reflect, and conserve energy.',
moonMod:(h)=>`The Moon in the ${h}th position from natal Moon signals a steady, even-keeled day. Routine work and planning proceed smoothly.`,
sadeSatiDesc:{rising:'Saturn has entered the 12th house from your natal Moon — the initial phase of Sade Sati begins. Unexpected expenses and the need for recalibration are common. Use this period to simplify, save, and build inner resilience.',peak:'Saturn transits directly over your natal Moon — the core phase of Sade Sati. Deep karmic lessons around responsibility, relationships, and foundations arrive. Patience and dharmic action are the remedies.',setting:'Saturn moves through the 2nd from natal Moon — Sade Sati concluding phase. Stability gradually returns; avoid financial overextension as this phase clears.',none:''},
kantakaDesc:'Saturn transits a quadrant from your natal Moon — a Kantaka Shani phase. Slow and deliberate action is favoured; avoid impulsive decisions in health, career, and relationships.',
jupDesc:{good:(h,gn)=>`Jupiter transits the ${h}th house from your Lagna, in ${gn} — a particularly auspicious placement. Expansion, wisdom, and blessings are active this year. It is a time to grow, learn, and invest in long-term foundations.`,challenging:(h,gn)=>`Jupiter transits the ${h}th house from Lagna, in ${gn}. Some friction in growth areas this year; channel Jupiter's wisdom inward — study, refine, and prepare rather than over-expand.`,moderate:(h,gn)=>`Jupiter transits the ${h}th house from Lagna, in ${gn}. A stabilising year; steady progress is available with consistent effort and clear priorities.`},
mahaDesc:(mp,ap)=>`The ${mp} Mahadasha${ap?', '+ap+' Antardasha,':''} governs this period. `,
yearTheme:(sadephase,jupq)=>sadephase?'This year calls for patience, inner groundwork, and long-range thinking — what is built carefully now stands firm for decades.':jupq==='good'?'This year carries the hallmark of Guru\'s blessings — growth, learning, and purposeful expansion are the dominant themes.':'This year rewards steady, disciplined effort. Small, consistent steps compound into meaningful progress.'
},
hi:{
heading:'व्यक्तिगत भविष्यवाणी',today:'आज',week:'इस सप्ताह',year:'इस वर्ष',
vsLabel:'विक्रम संवत',monthLabel:'हिन्दू माह',transitMoon:'गोचर चंद्र',
basisLabel:'ज्योतिषीय आधार',oppLabel:'अवसर',cautionLabel:'सावधानियाँ',guidanceLabel:'मार्गदर्शन',
sadeSati:{rising:'साढ़ेसाती आरंभ',peak:'साढ़ेसाती चरम',setting:'साढ़ेसाती समाप्ति',none:''},
kantaka:'कंटक शनि',
moonQ:{good:'शुभ दिन',challenging:'अंतर्मुखी दिन',moderate:'सामान्य दिन'},
jupQ:{good:'गुरु अनुकूल',challenging:'गुरु चुनौती',moderate:'गुरु संतुलित'},
moonD:(h,gn,natGn)=>`जन्म चंद्र ${natGn} से गोचर चंद्र ${h}वें स्थान में ${gn} में है। `,
moonGood:(h)=>h===1?'जन्म नक्षत्र — आत्म-चिंतन और संकल्प का दिन।':h===3?'तृतीय भाव — संचार और साहस अनुकूल। छोटी यात्राएं और संवाद शुभ।':h===6?'षष्ठ भाव — प्रतिस्पर्धा और संकल्प बलवान। चुनौतियों का सामना करें।':h===7?'सप्तम भाव — सामाजिक सौहार्द। साझेदारी और सहयोग शुभ।':h===10?'दशम भाव — कार्य में गति। व्यावसायिक प्रयास फलदायी।':'एकादश भाव — लाभ और नेटवर्किंग अनुकूल।',
moonChal:'अष्टम भाव — शांत और आत्म-विचार का दिन। बड़े निर्णय टालें, विश्राम करें।',
moonMod:(h)=>`${h}वें भाव में चंद्र — सामान्य, संतुलित दिन। नियमित कार्य और योजना सुचारु।`,
sadeSatiDesc:{rising:'शनि जन्म चंद्र से द्वादश भाव में — साढ़ेसाती का प्रारंभ। अप्रत्याशित खर्च और पुनर्मूल्यांकन। सरलता, बचत और आंतरिक दृढ़ता विकसित करें।',peak:'शनि सीधे जन्म चंद्र पर — साढ़ेसाती का चरम। जिम्मेदारी और नींव पर गहरे कर्म-पाठ। धैर्य और धर्मिक कार्य ही उपाय है।',setting:'शनि जन्म चंद्र से द्वितीय भाव में — साढ़ेसाती की समाप्ति। स्थिरता लौट रही है; वित्तीय संयम रखें।',none:''},
kantakaDesc:'शनि जन्म चंद्र से चतुर्थ/सप्तम/दशम भाव में — कंटक शनि। स्वास्थ्य, कार्य और संबंधों में विवेकपूर्ण निर्णय लें।',
jupDesc:{good:(h,gn)=>`गुरु जन्म लग्न से ${h}वें भाव में ${gn} में — अत्यंत शुभ। विस्तार, ज्ञान और आशीर्वाद सक्रिय। दीर्घकालिक नींव में निवेश करें।`,challenging:(h,gn)=>`गुरु ${h}वें भाव में — कुछ बाधाएं संभव। ज्ञान अंतर्मुखी करें — अध्ययन और परिष्कार का समय।`,moderate:(h,gn)=>`गुरु ${h}वें भाव में ${gn} में — स्थिर वर्ष। निरंतर प्रयास से प्रगति।`},
mahaDesc:(mp,ap)=>`${mp} महादशा${ap?', '+ap+' अंतर्दशा,':''} इस काल को नियंत्रित करती है। `,
yearTheme:(sp,jq)=>sp?'इस वर्ष धैर्य, आंतरिक कार्य और दीर्घकालिक दृष्टि अपनाएं।':jq==='good'?'इस वर्ष गुरु के आशीर्वाद से विकास और ज्ञान प्रमुख विषय हैं।':'इस वर्ष अनुशासित प्रयास से सार्थक प्रगति संभव है।'
},
kn:{
heading:'ವ್ಯಕ್ತಿಗತ ಭವಿಷ್ಯ',today:'ಇಂದು',week:'ಈ ವಾರ',year:'ಈ ವರ್ಷ',
vsLabel:'ವಿಕ್ರಮ ಸಂವತ್',monthLabel:'ಹಿಂದು ಮಾಸ',transitMoon:'ಗೋಚರ ಚಂದ್ರ',
basisLabel:'ಜ್ಯೋತಿಷ ಆಧಾರ',oppLabel:'ಅವಕಾಶಗಳು',cautionLabel:'ಎಚ್ಚರಿಕೆಗಳು',guidanceLabel:'ಮಾರ್ಗದರ್ಶನ',
sadeSati:{rising:'ಸಾಡೇಸಾತಿ ಆರಂಭ',peak:'ಸಾಡೇಸಾತಿ ತೀವ್ರ',setting:'ಸಾಡೇಸಾತಿ ಮುಕ್ತಾಯ',none:''},
kantaka:'ಕಂಟಕ ಶನಿ',
moonQ:{good:'ಶುಭ ದಿನ',challenging:'ಅಂತರ್ಮುಖಿ ದಿನ',moderate:'ಸ್ಥಿರ ದಿನ'},
jupQ:{good:'ಗುರು ಅನುಕೂಲ',challenging:'ಗುರು ಸವಾಲು',moderate:'ಗುರು ಸಮತೋಲ'},
moonD:(h,gn,natGn)=>`ಜನ್ಮ ಚಂದ್ರ ${natGn}ದಿಂದ ಗೋಚರ ಚಂದ್ರ ${h}ನೇ ಸ್ಥಾನದಲ್ಲಿ ${gn}ದಲ್ಲಿ ಇದ್ದಾರೆ. `,
moonGood:(h)=>h===1?'ಜನ್ಮ ನಕ್ಷತ್ರ — ಆತ್ಮಚಿಂತನ ಮತ್ತು ಸಂಕಲ್ಪಕ್ಕೆ ದಿನ.':h===3?'ತೃತೀಯ ಭಾವ — ಸಂವಹನ ಮತ್ತು ಸಣ್ಣ ಪ್ರಯಾಣ ಶುಭ.':h===6?'ಷಷ್ಠ ಭಾವ — ಸ್ಪರ್ಧಾತ್ಮಕ ಶಕ್ತಿ ಪ್ರಬಲ. ಸವಾಲುಗಳನ್ನು ಎದುರಿಸಿ.':h===7?'ಸಪ್ತಮ ಭಾವ — ಸಾಮಾಜಿಕ ಸೌಹಾರ್ದ. ಸಹಭಾಗಿತ್ವ ಶುಭ.':h===10?'ದಶಮ ಭಾವ — ವೃತ್ತಿ ಚಲನಶೀಲ. ಗೋಚರತೆ ಮತ್ತು ಕ್ರಿಯೆ ಫಲ ನೀಡುತ್ತವೆ.':'ಏಕಾದಶ ಭಾವ — ಲಾಭ ಮತ್ತು ನೆಟ್‌ವರ್ಕಿಂಗ್ ಅನುಕೂಲ.',
moonChal:'ಅಷ್ಟಮ ಭಾವ — ಶಾಂತ ಮತ್ತು ಆಂತರಿಕ ದಿನ. ದೊಡ್ಡ ನಿರ್ಧಾರ ಮುಂದೂಡಿ; ವಿಶ್ರಮಿಸಿ.',
moonMod:(h)=>`${h}ನೇ ಭಾವ — ಸ್ಥಿರ, ಸಮಾನ ದಿನ. ನಿಯಮಿತ ಕೆಲಸ ಮತ್ತು ಯೋಜನೆ ಸುಗಮ.`,
sadeSatiDesc:{rising:'ಶನಿ ಜನ್ಮ ಚಂದ್ರದಿಂದ ದ್ವಾದಶ ಭಾವದಲ್ಲಿ — ಸಾಡೇಸಾತಿ ಆರಂಭ. ಸರಳತೆ ಮತ್ತು ಆಂತರಿಕ ದೃಢತೆ ಬೆಳೆಸಿ.',peak:'ಶನಿ ನೇರವಾಗಿ ಜನ್ಮ ಚಂದ್ರದ ಮೇಲೆ — ತೀವ್ರ ಹಂತ. ಧೈರ್ಯ ಮತ್ತು ಧಾರ್ಮಿಕ ಕ್ರಿಯೆ ಉಪಾಯ.',setting:'ಶನಿ ದ್ವಿತೀಯ ಭಾವದಲ್ಲಿ — ಸಾಡೇಸಾತಿ ಕೊನೆ ಹಂತ. ಸ್ಥಿರತೆ ಮರಳುತ್ತಿದೆ.',none:''},
kantakaDesc:'ಶನಿ ಕಂಟಕ ಶನಿ ಸ್ಥಾನದಲ್ಲಿ. ಆರೋಗ್ಯ, ವೃತ್ತಿ ಮತ್ತು ಸಂಬಂಧಗಳಲ್ಲಿ ಎಚ್ಚರಿಕೆ ಇರಲಿ.',
jupDesc:{good:(h,gn)=>`ಗುರು ಜನ್ಮ ಲಗ್ನದಿಂದ ${h}ನೇ ಭಾವದಲ್ಲಿ ${gn}ದಲ್ಲಿ — ಅತ್ಯಂತ ಶುಭ. ವಿಸ್ತರಣೆ ಮತ್ತು ಜ್ಞಾನ ಸಕ್ರಿಯ.`,challenging:(h,gn)=>`ಗುರು ${h}ನೇ ಭಾವದಲ್ಲಿ — ಅಧ್ಯಯನ ಮತ್ತು ಪರಿಷ್ಕಾರ ಸಮಯ.`,moderate:(h,gn)=>`ಗುರು ${h}ನೇ ಭಾವದಲ್ಲಿ ${gn}ದಲ್ಲಿ — ಸ್ಥಿರ ವರ್ಷ.`},
mahaDesc:(mp,ap)=>`${mp} ಮಹಾದಶ${ap?', '+ap+' ಅಂತರ್ದಶ,':''} ಈ ಕಾಲ ನಿಯಂತ್ರಿಸುತ್ತದೆ. `,
yearTheme:(sp,jq)=>sp?'ಈ ವರ್ಷ ತಾಳ್ಮೆ, ಆಂತರಿಕ ಕೆಲಸ ಮತ್ತು ದೀರ್ಘಕಾಲೀನ ದೃಷ್ಟಿ ಅಗತ್ಯ.':jq==='good'?'ಈ ವರ್ಷ ಗುರುವಿನ ಆಶೀರ್ವಾದದಿಂದ ಬೆಳವಣಿಗೆ ಮತ್ತು ಜ್ಞಾನ ಪ್ರಮುಖ.':'ಈ ವರ್ಷ ಶಿಸ್ತಿನ ಪ್ರಯತ್ನದಿಂದ ಸಾರ್ಥಕ ಪ್ರಗತಿ ಸಾಧ್ಯ.'
},
te:{
heading:'వ్యక్తిగత భవిష్యత్తు',today:'ఈ రోజు',week:'ఈ వారం',year:'ఈ సంవత్సరం',
vsLabel:'విక్రమ సంవత్',monthLabel:'హిందూ మాసం',transitMoon:'గోచర చంద్రుడు',
basisLabel:'జ్యోతిష ఆధారం',oppLabel:'అవకాశాలు',cautionLabel:'జాగ్రత్తలు',guidanceLabel:'మార్గదర్శనం',
sadeSati:{rising:'సాడేసాటి ఆరంభం',peak:'సాడేసాటి తీవ్రత',setting:'సాడేసాటి ముగింపు',none:''},
kantaka:'కంటక శని',
moonQ:{good:'శుభ దినం',challenging:'అంతర్ముఖ దినం',moderate:'స్థిర దినం'},
jupQ:{good:'గురు అనుకూలం',challenging:'గురు సవాలు',moderate:'గురు సమతుల్యత'},
moonD:(h,gn,natGn)=>`జన్మ చంద్రుడు ${natGn} నుండి గోచర చంద్రుడు ${h}వ స్థానంలో ${gn}లో ఉన్నారు. `,
moonGood:(h)=>h===1?'జన్మ నక్షత్రం — ఆత్మచింతన మరియు సంకల్పానికి దినం.':h===3?'తృతీయ భావం — సంభాషణ మరియు చిన్న ప్రయాణాలు శుభం.':h===6?'షష్ఠ భావం — పోటీ శక్తి బలం. సవాళ్లను ఎదుర్కొనండి.':h===7?'సప్తమ భావం — సామాజిక సామరస్యం. భాగస్వామ్యాలు శుభం.':h===10?'దశమ భావం — వృత్తి వేగం. కృషి ఫలిస్తుంది.':'ఏకాదశ భావం — లాభం మరియు నెట్‌వర్కింగ్ అనుకూలం.',
moonChal:'అష్టమ భావం — ప్రశాంత మరియు అంతర్ముఖ దినం. పెద్ద నిర్ణయాలు వాయిదా వేయండి.',
moonMod:(h)=>`${h}వ భావం — స్థిర, సమతుల్య దినం. రోజువారీ పని సుగమం.`,
sadeSatiDesc:{rising:'శని జన్మ చంద్రుని నుండి ద్వాదశ భావంలో — సాడేసాటి ఆరంభం. సరళత మరియు ఆంతరిక దృఢత పెంచుకోండి.',peak:'శని నేరుగా జన్మ చంద్రునిపై — తీవ్ర దశ. ధైర్యం మరియు ధార్మిక కార్యం పరిష్కారం.',setting:'శని ద్వితీయ భావంలో — సాడేసాటి ముగింపు. స్థిరత్వం తిరిగొస్తోంది.',none:''},
kantakaDesc:'శని కంటక స్థానంలో. ఆరోగ్యం, వృత్తి మరియు సంబంధాలలో జాగ్రత్త అవసరం.',
jupDesc:{good:(h,gn)=>`గురువు జన్మ లగ్నం నుండి ${h}వ భావంలో ${gn}లో — అత్యంత శుభం. వ్యాప్తి మరియు జ్ఞానం సక్రియం.`,challenging:(h,gn)=>`గురువు ${h}వ భావంలో — అభ్యాసం మరియు పరిమార్జన సమయం.`,moderate:(h,gn)=>`గురువు ${h}వ భావంలో ${gn}లో — స్థిర సంవత్సరం.`},
mahaDesc:(mp,ap)=>`${mp} మహాదశ${ap?', '+ap+' అంతర్దశ,':''} ఈ కాలాన్ని నిర్వహిస్తుంది. `,
yearTheme:(sp,jq)=>sp?'ఈ సంవత్సరం సహనం, అంతర్గత పని మరియు దీర్ఘకాలిక దృష్టి అవసరం.':jq==='good'?'ఈ సంవత్సరం గురువు దయతో వ్యాప్తి మరియు జ్ఞానం ప్రధాన అంశాలు.':'ఈ సంవత్సరం క్రమశిక్షణతో నిరంతర కృషి ద్వారా ప్రగతి సాధ్యం.'
},
ta:{
heading:'தனிப்பட்ட முன்னறிவிப்பு',today:'இன்று',week:'இந்த வாரம்',year:'இந்த ஆண்டு',
vsLabel:'விக்ரம சம்வத்',monthLabel:'இந்து மாதம்',transitMoon:'கோச்சார சந்திரன்',
basisLabel:'ஜோதிட அடிப்படை',oppLabel:'வாய்ப்புகள்',cautionLabel:'எச்சரிக்கைகள்',guidanceLabel:'வழிகாட்டுதல்',
sadeSati:{rising:'சாடேசாட்டி ஆரம்பம்',peak:'சாடேசாட்டி உச்சம்',setting:'சாடேசாட்டி முடிவு',none:''},
kantaka:'கண்டக சனி',
moonQ:{good:'சுபமான நாள்',challenging:'அகமுகமான நாள்',moderate:'நிலையான நாள்'},
jupQ:{good:'குரு சாதகம்',challenging:'குரு சவால்',moderate:'குரு சமநிலை'},
moonD:(h,gn,natGn)=>`ஜன்ம சந்திரன் ${natGn}லிருந்து கோச்சார சந்திரன் ${h}வது இடத்தில் ${gn}லில் உள்ளார். `,
moonGood:(h)=>h===1?'ஜன்ம நட்சத்திரம் — சுய சிந்தனை மற்றும் நோக்கம் அமைக்க நாள்.':h===3?'மூன்றாம் இடம் — தகவல் தொடர்பு மற்றும் குறு பயணங்கள் சுபம்.':h===6?'ஆறாம் இடம் — போட்டி சக்தி வலிமையானது. சவால்களை எதிர்கொள்ளுங்கள்.':h===7?'ஏழாம் இடம் — சமூக நல்லிணக்கம். கூட்டு சுபம்.':h===10?'பத்தாம் இடம் — தொழில் வேகம். தெரிவு மற்றும் செயல் பலன் தரும்.':'பதினொன்றாம் இடம் — ஆதாயம் மற்றும் நெட்வொர்க்கிங் சாதகம்.',
moonChal:'எட்டாம் இடம் — அமைதியான, அகமுகமான நாள். முக்கிய முடிவுகள் தவிர்க்கவும்.',
moonMod:(h)=>`${h}வது இடம் — நிலையான, சமநிலை நாள். வழக்கமான பணி சுமூகம்.`,
sadeSatiDesc:{rising:'சனி ஜன்ம சந்திரனிலிருந்து பன்னிரண்டாம் இடத்தில் — சாடேசாட்டி ஆரம்பம். எளிமை மற்றும் உள் நெகிழ்ச்சி வளர்க்கவும்.',peak:'சனி ஜன்ம சந்திரன் மீது நேரடியாக — உச்ச கட்டம். பொறுமை மற்றும் தர்ம செயல்கள் தீர்வு.',setting:'சனி இரண்டாம் இடத்தில் — சாடேசாட்டி முடிவு கட்டம். ஸ்திரம் திரும்புகிறது.',none:''},
kantakaDesc:'சனி கண்டக நிலையில். உடல்நலம், தொழில் மற்றும் உறவுகளில் கவனம் தேவை.',
jupDesc:{good:(h,gn)=>`குரு ஜன்ம லக்னத்திலிருந்து ${h}வது இடத்தில் ${gn}லில் — மிகவும் சுபம். விரிவாக்கம் மற்றும் ஞானம் செயலில்.`,challenging:(h,gn)=>`குரு ${h}வது இடத்தில் — கற்றல் மற்றும் சுத்திகரிப்பு காலம்.`,moderate:(h,gn)=>`குரு ${h}வது இடத்தில் ${gn}லில் — நிலையான வருடம்.`},
mahaDesc:(mp,ap)=>`${mp} மகாதசை${ap?', '+ap+' அந்தர்தசை,':''} இக்காலத்தை நிர்வகிக்கிறது. `,
yearTheme:(sp,jq)=>sp?'இந்த ஆண்டு பொறுமை, உள் பணி மற்றும் நீண்ட கால சிந்தனை தேவை.':jq==='good'?'இந்த ஆண்டு குரு அருளால் வளர்ச்சி மற்றும் ஞானம் முக்கிய கருப்பொருள்.':'இந்த ஆண்டு ஒழுங்கான முயற்சியால் அர்த்தமுள்ள முன்னேற்றம் சாத்தியம்.'
},
sa:{
heading:'व्यक्तिगतं भविष्यफलम्',today:'अद्य',week:'अस्मिन् सप्ताहे',year:'अस्मिन् वर्षे',
vsLabel:'विक्रमसंवत्',monthLabel:'हिन्दुमासः',transitMoon:'गोचरचन्द्रः',
basisLabel:'ज्योतिषाधारः',oppLabel:'अवसराः',cautionLabel:'सावधानता',guidanceLabel:'मार्गदर्शनम्',
sadeSati:{rising:'साढेसाती आरम्भः',peak:'साढेसाती उच्चतमः',setting:'साढेसाती समाप्तिः',none:''},
kantaka:'कण्टकशनिः',
moonQ:{good:'शुभदिनम्',challenging:'अन्तर्मुखदिनम्',moderate:'स्थिरदिनम्'},
jupQ:{good:'गुरुः अनुकूलः',challenging:'गुरुः चुनौतिः',moderate:'गुरुः संतुलितः'},
moonD:(h,gn,natGn)=>`जन्मचन्द्रात् ${natGn}तः गोचरचन्द्रः ${h}तमे स्थाने ${gn}रे अस्ति। `,
moonGood:(h)=>h===1?'जन्मनक्षत्रम् — आत्मचिन्तनाय संकल्पाय च दिनम्.':h===3?'तृतीयभावः — संवादः लघुयात्रा च शुभाः.':h===6?'षष्ठभावः — स्पर्धाशक्तिः प्रबला. चुनौतीः सम्मुखीभव.':h===7?'सप्तमभावः — सामाजिकसौहार्दम्. साझेदारी शुभा.':h===10?'दशमभावः — व्यावसायिकगतिः. दृश्यता फलदायिनी.':'एकादशभावः — लाभः नेटवर्किङ्गं च अनुकूलम्.',
moonChal:'अष्टमभावः — शान्तः आन्तरिकः दिवसः. महत्त्वपूर्णनिर्णयान् त्यजेत्.',
moonMod:(h)=>`${h}तमभावः — स्थिरः समः दिवसः. नियमितकार्यं सुचारु.`,
sadeSatiDesc:{rising:'शनिः जन्मचन्द्रात् द्वादशभावे — साढेसाती आरम्भः. सरलतां आन्तरिकदृढतां च वर्धयतु.',peak:'शनिः सीधे जन्मचन्द्रे — उच्चावस्था. धैर्यं धर्मिककार्यं च उपायः.',setting:'शनिः द्वितीयभावे — साढेसाती समाप्तिः. स्थिरता प्रत्यागच्छति.',none:''},
kantakaDesc:'शनिः कण्टकस्थाने. स्वास्थ्ये व्यवसाये सम्बन्धेषु च विवेकः आवश्यकः.',
jupDesc:{good:(h,gn)=>`गुरुः जन्मलग्नात् ${h}तमे भावे ${gn}रे — अतिशुभम्. विस्तारः ज्ञानं च सक्रियम्.`,challenging:(h,gn)=>`गुरुः ${h}तमे भावे — अध्ययनं परिष्काराय च कालः.`,moderate:(h,gn)=>`गुरुः ${h}तमे भावे ${gn}रे — स्थिरवर्षम्.`},
mahaDesc:(mp,ap)=>`${mp} महादशा${ap?', '+ap+' अन्तर्दशा,':''} एतत्कालं नियन्त्रयति. `,
yearTheme:(sp,jq)=>sp?'अस्मिन् वर्षे धैर्यम् आन्तरिककार्यं दीर्घदृष्टिः च आवश्यकाः.':jq==='good'?'अस्मिन् वर्षे गुरोः आशीर्वादेन विस्तारः ज्ञानं च प्रधानविषयौ.':'अस्मिन् वर्षे अनुशासितप्रयत्नेन सार्थकप्रगतिः सम्भवा.'
},
mr:{
heading:'वैयक्तिक भविष्य',today:'आज',week:'या आठवड्यात',year:'या वर्षी',
vsLabel:'विक्रम संवत',monthLabel:'हिंदू मास',transitMoon:'गोचर चंद्र',
basisLabel:'ज्योतिष आधार',oppLabel:'संधी',cautionLabel:'सावधानता',guidanceLabel:'मार्गदर्शन',
sadeSati:{rising:'साडेसाती सुरुवात',peak:'साडेसाती शिखर',setting:'साडेसाती समाप्ती',none:''},
kantaka:'कंटक शनी',
moonQ:{good:'शुभ दिवस',challenging:'अंतर्मुखी दिवस',moderate:'स्थिर दिवस'},
jupQ:{good:'गुरू अनुकूल',challenging:'गुरू आव्हान',moderate:'गुरू संतुलित'},
moonD:(h,gn,natGn)=>`जन्म चंद्र ${natGn}पासून गोचर चंद्र ${h}व्या स्थानात ${gn}मध्ये आहे. `,
moonGood:(h)=>h===1?'जन्म नक्षत्र — आत्मचिंतन आणि संकल्पासाठी दिवस.':h===3?'तृतीय भाव — संवाद आणि छोट्या सहली शुभ.':h===6?'षष्ठ भाव — स्पर्धात्मक शक्ती प्रबळ. आव्हाने झेला.':h===7?'सप्तम भाव — सामाजिक सौहार्द. भागीदारी शुभ.':h===10?'दशम भाव — व्यावसायिक गती. दृश्यमानता फलदायी.':'एकादश भाव — लाभ आणि नेटवर्किंग अनुकूल.',
moonChal:'अष्टम भाव — शांत आणि आंतरिक दिवस. मोठे निर्णय पुढे ढकला.',
moonMod:(h)=>`${h}व्या भावात चंद्र — स्थिर, सम दिवस. नियमित काम सुरळीत.`,
sadeSatiDesc:{rising:'शनी जन्म चंद्रापासून द्वादश भावात — साडेसाती सुरुवात. सरलता आणि आंतरिक बळ वाढवा.',peak:'शनी थेट जन्म चंद्रावर — शिखर अवस्था. धैर्य आणि धार्मिक कार्य उपाय.',setting:'शनी द्वितीय भावात — साडेसाती समाप्ती. स्थिरता परत येत आहे.',none:''},
kantakaDesc:'शनी कंटक स्थानात. आरोग्य, कार्य आणि नातेसंबंधात विवेक ठेवा.',
jupDesc:{good:(h,gn)=>`गुरू जन्म लग्नापासून ${h}व्या भावात ${gn}मध्ये — अत्यंत शुभ. विस्तार आणि ज्ञान सक्रिय.`,challenging:(h,gn)=>`गुरू ${h}व्या भावात — अध्ययन आणि परिष्काराची वेळ.`,moderate:(h,gn)=>`गुरू ${h}व्या भावात ${gn}मध्ये — स्थिर वर्ष.`},
mahaDesc:(mp,ap)=>`${mp} महादशा${ap?', '+ap+' अंतर्दशा,':''} हा काळ नियंत्रित करते. `,
yearTheme:(sp,jq)=>sp?'या वर्षी संयम, आंतरिक कार्य आणि दीर्घकालीन दृष्टी आवश्यक.':jq==='good'?'या वर्षी गुरूच्या आशीर्वादाने विस्तार आणि ज्ञान प्रमुख.':'या वर्षी शिस्तबद्ध प्रयत्नाने सार्थक प्रगती शक्य.'
},
gu:{
heading:'વ્યક્તિગત ભવિષ્ય',today:'આજ',week:'આ સપ્તાહ',year:'આ વર્ષ',
vsLabel:'વિક્રમ સંવત',monthLabel:'હિંદુ માસ',transitMoon:'ગોચર ચંદ્ર',
basisLabel:'જ્યોતિષ આધાર',oppLabel:'તકો',cautionLabel:'સાવચેતીઓ',guidanceLabel:'માર્ગદર્શન',
sadeSati:{rising:'સાડેસાટી શરૂ',peak:'સાડેસાટી ચરમ',setting:'સાડેસાટી સમાપ્તિ',none:''},
kantaka:'કંટક શનિ',
moonQ:{good:'શુભ દિવસ',challenging:'અંતર્મુખ દિવસ',moderate:'સ્થિર દિવસ'},
jupQ:{good:'ગુરુ અનુકૂળ',challenging:'ગુરુ પડકાર',moderate:'ગુરુ સંતુલિત'},
moonD:(h,gn,natGn)=>`જન્મ ચંદ્ર ${natGn}થી ગોચર ચંદ્ર ${h}મા સ્થાનમાં ${gn}માં છે. `,
moonGood:(h)=>h===1?'જન્મ નક્ષત્ર — આત્મ-ચિંતન અને સંકલ્પ માટે દિવસ.':h===3?'ત્રીજો ભાવ — સંચાર અને ટૂંકી યાત્રા શુભ.':h===6?'છઠ્ઠો ભાવ — સ્પર્ધાત્મક ઊર્જા મજબૂત.':h===7?'સાતમો ભાવ — સામાજિક સૌહાર્દ. ભાગીદારી શુભ.':h===10?'દસમો ભાવ — વ્યવસાયિક ગતિ. ક્રિયા ફળ આપે.':'અગિયારમો ભાવ — લાભ અને નેટવર્કિંગ અનુકૂળ.',
moonChal:'આઠમો ભાવ — શાંત, અંતર્મુખ દિવસ. મોટા નિર્ણય ટાળો.',
moonMod:(h)=>`${h}મા ભાવ — સ્થિર, સમ દિવસ. નિયમિત કામ સુગમ.`,
sadeSatiDesc:{rising:'શનિ જન્મ ચંદ્રથી બારમા ભાવમાં — સાડેસાટી શરૂ. સરળતા અને આંતરિક દ્રઢતા કેળવો.',peak:'શનિ સીધો જન્મ ચંદ્ર પર — ચરમ અવસ્થા. ધૈર્ય અને ધર્મ-કાર્ય ઉપાય.',setting:'શનિ બીજા ભાવમાં — સાડેસાટી સમાપ્તિ. સ્થિરતા પાછી આવી રહી છે.',none:''},
kantakaDesc:'શનિ કંટક સ્થાનમાં. સ્વાસ્થ્ય, કારકિર્દી અને સંબંધોમાં સાવધ રહો.',
jupDesc:{good:(h,gn)=>`ગુરુ જન્મ લગ્નથી ${h}મા ભાવમાં ${gn}માં — ઘણા શુભ. વિસ્તાર અને જ્ઞાન સક્રિય.`,challenging:(h,gn)=>`ગુરુ ${h}મા ભાવમાં — અભ્યાસ અને પરિષ્કારનો સમય.`,moderate:(h,gn)=>`ગુરુ ${h}મા ભાવમાં ${gn}માં — સ્થિર વર્ષ.`},
mahaDesc:(mp,ap)=>`${mp} મહાદશા${ap?', '+ap+' અંતર્દશા,':''} આ સમય નિયંત્રિત કરે છે. `,
yearTheme:(sp,jq)=>sp?'આ વર્ષ ધૈર્ય, આંતરિક કાર્ય અને દીર્ઘકાલીન દૃષ્ટિ જરૂરી.':jq==='good'?'આ વર્ષ ગુરુના આશીર્વાદથી વિકાસ અને જ્ઞાન મુખ્ય.':'આ વર્ષ શિસ્તબદ્ધ પ્રયત્નથી સાર્થક પ્રગતિ શક્ય.'
},
bn:{
heading:'ব্যক্তিগত পূর্বাভাস',today:'আজ',week:'এই সপ্তাহ',year:'এই বছর',
vsLabel:'বিক্রম সংবৎ',monthLabel:'হিন্দু মাস',transitMoon:'গোচর চন্দ্র',
basisLabel:'জ্যোতিষ ভিত্তি',oppLabel:'সুযোগ',cautionLabel:'সতর্কতা',guidanceLabel:'নির্দেশনা',
sadeSati:{rising:'সাড়েসাতি শুরু',peak:'সাড়েসাতি চরম',setting:'সাড়েসাতি সমাপ্তি',none:''},
kantaka:'কণ্টক শনি',
moonQ:{good:'শুভ দিন',challenging:'অন্তর্মুখী দিন',moderate:'স্থিতিশীল দিন'},
jupQ:{good:'গুরু অনুকূল',challenging:'গুরু চ্যালেঞ্জ',moderate:'গুরু সুষম'},
moonD:(h,gn,natGn)=>`জন্ম চন্দ্র ${natGn} থেকে গোচর চন্দ্র ${h}ম স্থানে ${gn}তে আছেন। `,
moonGood:(h)=>h===1?'জন্ম নক্ষত্র — আত্মচিন্তন ও সংকল্পের দিন.':h===3?'তৃতীয় ভাব — যোগাযোগ ও ছোট ভ্রমণ শুভ.':h===6?'ষষ্ঠ ভাব — প্রতিযোগিতামূলক শক্তি প্রবল.':h===7?'সপ্তম ভাব — সামাজিক সম্প্রীতি. অংশীদারিত্ব শুভ.':h===10?'দশম ভাব — কর্মজীবনে গতি. দৃশ্যমানতা ফলদায়ী.':'একাদশ ভাব — লাভ ও নেটওয়ার্কিং অনুকূল.',
moonChal:'অষ্টম ভাব — শান্ত, অন্তর্মুখী দিন. বড় সিদ্ধান্ত এড়িয়ে চলুন.',
moonMod:(h)=>`${h}ম ভাবে চন্দ্র — স্থির, সুষম দিন. নিয়মিত কাজ সুচারু.`,
sadeSatiDesc:{rising:'শনি জন্ম চন্দ্র থেকে দ্বাদশ ভাবে — সাড়েসাতি শুরু. সরলতা ও আত্মিক দৃঢ়তা গড়ুন.',peak:'শনি সরাসরি জন্ম চন্দ্রে — চরম দশা. ধৈর্য ও ধার্মিক কর্ম সমাধান.',setting:'শনি দ্বিতীয় ভাবে — সাড়েসাতি সমাপ্তি. স্থিতিশীলতা ফিরছে.',none:''},
kantakaDesc:'শনি কণ্টক স্থানে. স্বাস্থ্য, কর্ম ও সম্পর্কে সতর্কতা প্রয়োজন.',
jupDesc:{good:(h,gn)=>`গুরু জন্ম লগ্ন থেকে ${h}ম ভাবে ${gn}তে — অত্যন্ত শুভ. বিস্তার ও জ্ঞান সক্রিয়.`,challenging:(h,gn)=>`গুরু ${h}ম ভাবে — অধ্যয়ন ও পরিশোধনের সময়.`,moderate:(h,gn)=>`গুরু ${h}ম ভাবে ${gn}তে — স্থিতিশীল বছর.`},
mahaDesc:(mp,ap)=>`${mp} মহাদশা${ap?', '+ap+' অন্তর্দশা,':''} এই সময় নিয়ন্ত্রণ করছে। `,
yearTheme:(sp,jq)=>sp?'এই বছর ধৈর্য, অন্তর্গত কাজ ও দীর্ঘমেয়াদী দৃষ্টিভঙ্গি প্রয়োজন.':jq==='good'?'এই বছর গুরুর আশীর্বাদে বিস্তার ও জ্ঞান মুখ্য বিষয়.':'এই বছর শৃঙ্খলাবদ্ধ প্রচেষ্টায় অর্থবহ অগ্রগতি সম্ভব.'
},
ml:{
heading:'വ്യക്തിഗത പ്രവചനം',today:'ഇന്ന്',week:'ഈ ആഴ്ച',year:'ഈ വർഷം',
vsLabel:'വിക്രമ സംവത്',monthLabel:'ഹിന്ദു മാസം',transitMoon:'ഗോചര ചന്ദ്രൻ',
basisLabel:'ജ്യോതിഷ അടിത്തറ',oppLabel:'അവസരങ്ങൾ',cautionLabel:'ജാഗ്രതകൾ',guidanceLabel:'മാർഗ്ഗദർശനം',
sadeSati:{rising:'സാഡേസാതി ആരംഭം',peak:'സാഡേസാതി ഉച്ചം',setting:'സാഡേസാതി അവസാനം',none:''},
kantaka:'കണ്ടക ശനി',
moonQ:{good:'ശുഭ ദിനം',challenging:'അന്തർമുഖ ദിനം',moderate:'സ്ഥിര ദിനം'},
jupQ:{good:'ഗുരു അനുകൂലം',challenging:'ഗുരു വെല്ലുവിളി',moderate:'ഗുരു സന്തുലനം'},
moonD:(h,gn,natGn)=>`ജന്മ ചന്ദ്രൻ ${natGn}ൽ നിന്ന് ഗോചര ചന്ദ്രൻ ${h}ആം സ്ഥാനത്ത് ${gn}ൽ ഉണ്ട്. `,
moonGood:(h)=>h===1?'ജന്മ നക്ഷത്രം — ആത്മ-ചിന്തനത്തിനും സങ്കൽപ്പത്തിനും ദിനം.':h===3?'തൃതീയ ഭാവം — ആശയ വിനിമയവും ചെറു യാത്രകളും ശുഭം.':h===6?'ഷഷ്ഠ ഭാവം — മൽസര ഊർജ്ജം ശക്തം. വെല്ലുവിളികൾ നേരിടൂ.':h===7?'സപ്തമ ഭാവം — സാമൂഹ്യ ഐക്യം. പങ്കാളിത്തം ശുഭം.':h===10?'ദശമ ഭാവം — ജോലിയിൽ ഗതി. ദൃശ്യത ഫലദായകം.':'ഏകാദശ ഭാവം — നേട്ടവും നെറ്റ്‌വർക്കിങ്ങും അനുകൂലം.',
moonChal:'അഷ്ടമ ഭാവം — ശാന്തമായ, അന്തർമുഖ ദിനം. വലിയ തീരുമാനങ്ങൾ ഒഴിവാക്കൂ.',
moonMod:(h)=>`${h}ആം ഭാവം — സ്ഥിരമായ, സമ ദിനം. പതിവ് ജോലി സുഗമം.`,
sadeSatiDesc:{rising:'ശനി ജന്മ ചന്ദ്രനിൽ നിന്ന് ദ്വാദശ ഭാവത്തിൽ — സാഡേസാതി ആരംഭം. ലളിതത്വവും ആന്തരിക ദൃഢതയും വളർത്തൂ.',peak:'ശനി ജന്മ ചന്ദ്രനിൽ നേരിട്ട് — തീവ്ര ഘട്ടം. ക്ഷമയും ധർമ്മ കർമ്മവും പരിഹാരം.',setting:'ശനി ദ്വിതീയ ഭാവത്തിൽ — സാഡേസാതി അവസാനം. സ്ഥിരത തിരിച്ചുവരുന്നു.',none:''},
kantakaDesc:'ശനി കണ്ടക സ്ഥാനത്ത്. ആരോഗ്യം, ജോലി, ബന്ധങ്ങളിൽ ശ്രദ്ധ വേണം.',
jupDesc:{good:(h,gn)=>`ഗുരു ജന്മ ലഗ്നത്തിൽ നിന്ന് ${h}ആം ഭാവത്തിൽ ${gn}ൽ — ഏറ്റവും ശുഭം. വ്യാപ്തിയും ജ്ഞാനവും സജീവം.`,challenging:(h,gn)=>`ഗുരു ${h}ആം ഭാവത്തിൽ — പഠനവും പരിഷ്‌കരണവും നടത്തേണ്ട സമയം.`,moderate:(h,gn)=>`ഗുരു ${h}ആം ഭാവത്തിൽ ${gn}ൽ — സ്ഥിര വർഷം.`},
mahaDesc:(mp,ap)=>`${mp} മഹാദശ${ap?', '+ap+' അന്തർദശ,':''} ഈ കാലം നിയന്ത്രിക്കുന്നു. `,
yearTheme:(sp,jq)=>sp?'ഈ വർഷം ക്ഷമ, ആന്തരിക പ്രവർത്തനം, ദീർഘദൃഷ്ടി ആവശ്യം.':jq==='good'?'ഈ വർഷം ഗുരുവിൻ്റെ അനുഗ്രഹത്തിൽ വ്യാപ്തിയും ജ്ഞാനവും പ്രധാന വിഷയങ്ങൾ.':'ഈ വർഷം ക്രമബദ്ധ പ്രയത്‌നത്തിൽ അർഥവത്തായ പുരോഗതി സാദ്ധ്യം.'
}};
...
const L_HOUSE_THEMES={
en:['','Self & Personality','Wealth & Family','Courage & Siblings','Home & Happiness','Intelligence & Children','Health & Enemies','Partnerships & Marriage','Transformation & Longevity','Dharma & Fortune','Career & Status','Gains & Aspirations','Losses & Liberation'],
hi:['','आत्मा एवं व्यक्तित्व','धन एवं परिवार','साहस एवं भाई-बहन','गृह एवं सुख','बुद्धि एवं संतान','स्वास्थ्य एवं शत्रु','साझेदारी एवं विवाह','रूपांतरण एवं दीर्घायु','धर्म एवं भाग्य','कर्म एवं प्रतिष्ठा','लाभ एवं आकांक्षा','व्यय एवं मोक्ष'],
kn:['','ಆತ್ಮ ಮತ್ತು ವ್ಯಕ್ತಿತ್ವ','ಧನ ಮತ್ತು ಕುಟುಂಬ','ಧೈರ್ಯ ಮತ್ತು ಸಹೋದರರು','ಮನೆ ಮತ್ತು ಸುಖ','ಬುದ್ಧಿ ಮತ್ತು ಮಕ್ಕಳು','ಆರೋಗ್ಯ ಮತ್ತು ಶತ್ರುಗಳು','ಪಾಲುದಾರಿಕೆ ಮತ್ತು ವಿವಾಹ','ಪರಿವರ್ತನೆ ಮತ್ತು ದೀರ್ಘಾಯು','ಧರ್ಮ ಮತ್ತು ಭಾಗ್ಯ','ವೃತ್ತಿ ಮತ್ತು ಸ್ಥಾನ','ಲಾಭ ಮತ್ತು ಆಕಾಂಕ್ಷೆ','ವ್ಯಯ ಮತ್ತು ಮೋಕ್ಷ'],
te:['','ఆత్మ మరియు వ్యక్తిత్వం','ధనం మరియు కుటుంబం','ధైర్యం మరియు సహోదరులు','గృహం మరియు సుఖం','బుద్ధి మరియు సంతానం','ఆరోగ్యం మరియు శత్రువులు','భాగస్వామ్యం మరియు వివాహం','పరివర్తన మరియు దీర్ఘాయువు','ధర్మం మరియు భాగ్యం','వృత్తి మరియు హోదా','లాభం మరియు ఆకాంక్షలు','వ్యయం మరియు మోక్షం'],
ta:['','ஆன்மா & ஆளுமை','செல்வம் & குடும்பம்','தைரியம் & உடன்பிறப்புகள்','இல்லம் & சுகம்','புத்தி & குழந்தைகள்','ஆரோக்கியம் & எதிரிகள்','கூட்டாண்மை & திருமணம்','மாற்றம் & நீண்ட ஆயுள்','தர்மம் & அதிர்ஷ்டம்','தொழில் & அந்தஸ்து','ஆதாயம் & லட்சியங்கள்','இழப்பு & முக்தி'],
sa:['','आत्मा व्यक्तित्वं च','धनं कुटुम्बं च','शौर्यं भ्रातरश्च','गृहं सौख्यं च','बुद्धिः सन्तानं च','स्वास्थ्यं शत्रवश्च','साझेदारी विवाहश्च','परिवर्तनं दीर्घायुश्च','धर्मः भाग्यं च','वृत्तिः प्रतिष्ठा च','लाभः आकाङ्क्षाश्च','व्ययः मोक्षश्च'],
mr:['','आत्मा आणि व्यक्तिमत्व','धन आणि कुटुंब','धैर्य आणि भावंडे','गृह आणि सुख','बुद्धी आणि संतती','आरोग्य आणि शत्रू','भागीदारी आणि विवाह','परिवर्तन आणि दीर्घायुष्य','धर्म आणि भाग्य','कार्य आणि प्रतिष्ठा','लाभ आणि आकांक्षा','व्यय आणि मोक्ष'],
gu:['','આત્મા અને વ્યક્તિત્વ','ધન અને કુટુંબ','સાહસ અને ભાઈ-બહેન','ઘર અને સુખ','બુદ્ધિ અને સંતાન','આરોગ્ય અને શત્રુ','ભાગીદારી અને લગ્ન','પરિવર્તન અને દીર્ઘાયુ','ધર્મ અને ભાગ્ય','કારકિર્દી અને પ્રતિષ્ઠા','લાભ અને આકાંક્ષા','ખર્ચ અને મોક્ષ'],
bn:['','আত্মা ও ব্যক্তিত্ব','ধন ও পরিবার','সাহস ও ভাইবোন','গৃহ ও সুখ','বুদ্ধি ও সন্তান','স্বাস্থ্য ও শত্রু','অংশীদারিত্ব ও বিবাহ','রূপান্তর ও দীর্ঘায়ু','ধর্ম ও ভাগ্য','কর্মজীবন ও মর্যাদা','লাভ ও আকাঙ্ক্ষা','ব্যয় ও মোক্ষ'],
ml:['','ആത്മാവ് & വ്യക്തിത്വം','ധനം & കുടുംബം','ധൈര്യം & സഹോദരങ്ങൾ','ഗൃഹം & സുഖം','ബുദ്ധി & മക്കൾ','ആരോഗ്യം & ശത്രുക്കൾ','പങ്കാളിത്തം & വിവാഹം','പരിവർത്തനം & ദീർഘായുസ്സ്','ധർമ്മം & ഭാഗ്യം','ജോലി & പദവി','നേട്ടം & ആഗ്രഹങ്ങൾ','നഷ്ടം & മോക്ഷം']
};

const L_PREDICT={
en:{analysis:'Your Personalized Analysis',
moonTitle:'Moon Transit — Emotional Weather',jupTitle:'Jupiter Transit — Expansion & Fortune',
satTitle:'Saturn Transit — Karma & Responsibility',dashaTitle:'Your Current Dasha — Planetary Period',
wisdomTitle:'Your Inner Strength & Wisdom',
transitMoon:'Transit Moon',natalMoon:'Natal Moon',moonHouseThemes:'Moon House Themes',
jupNow:'Jupiter Now',fromLagna:'From Your Lagna',jupNatal:'Jupiter Natal',jupLords:'Jupiter Lords',
satNow:'Saturn Now',fromNatMoon:'From Natal Moon',satNatal:'Saturn Natal',
sadeSatiPhase:'Sade Sati Phase',kantakaShani:'Kantaka Shani',
mahadasha:'Mahadasha',antardasha:'Antardasha',duration:'Duration',
mahaPlanet:'Mahadasha Planet',antarPlanet:'Antardasha Planet',
house:'House',houses:'Houses',transitNote:'Based on current planetary transits over your birth chart. Transit positions change daily.',
sunIn:'Sun in',saturnIn:'Saturn in',jupiter:'Jupiter',saturn:'Saturn',yogaLabel:'Yoga'},
hi:{analysis:'आपका व्यक्तिगत विश्लेषण',
moonTitle:'चंद्र गोचर — भावनात्मक मौसम',jupTitle:'गुरु गोचर — विस्तार एवं भाग्य',
satTitle:'शनि गोचर — कर्म एवं दायित्व',dashaTitle:'आपकी वर्तमान दशा — ग्रह काल',
wisdomTitle:'आपकी आंतरिक शक्ति एवं ज्ञान',
transitMoon:'गोचर चंद्र',natalMoon:'जन्म चंद्र',moonHouseThemes:'चंद्र भाव विषय',
jupNow:'गुरु वर्तमान',fromLagna:'लग्न से',jupNatal:'जन्म गुरु',jupLords:'गुरु स्वामित्व',
satNow:'शनि वर्तमान',fromNatMoon:'जन्म चंद्र से',satNatal:'जन्म शनि',
sadeSatiPhase:'साढ़ेसाती चरण',kantakaShani:'कंटक शनि',
mahadasha:'महादशा',antardasha:'अंतर्दशा',duration:'अवधि',
mahaPlanet:'महादशा ग्रह',antarPlanet:'अंतर्दशा ग्रह',
house:'भाव',houses:'भाव',transitNote:'आपकी जन्म कुंडली पर वर्तमान ग्रह गोचर पर आधारित। गोचर स्थिति प्रतिदिन बदलती है।',
sunIn:'सूर्य',saturnIn:'शनि',jupiter:'गुरु',saturn:'शनि',yogaLabel:'योग'},
kn:{analysis:'ನಿಮ್ಮ ವೈಯಕ್ತಿಕ ವಿಶ್ಲೇಷಣೆ',
moonTitle:'ಚಂದ್ರ ಗೋಚಾರ — ಭಾವನಾತ್ಮಕ ಹವಾಮಾನ',jupTitle:'ಗುರು ಗೋಚಾರ — ವಿಸ್ತಾರ ಮತ್ತು ಭಾಗ್ಯ',
satTitle:'ಶನಿ ಗೋಚಾರ — ಕರ್ಮ ಮತ್ತು ಜವಾಬ್ದಾರಿ',dashaTitle:'ನಿಮ್ಮ ಪ್ರಸ್ತುತ ದಶೆ — ಗ್ರಹ ಅವಧಿ',
wisdomTitle:'ನಿಮ್ಮ ಆಂತರಿಕ ಶಕ್ತಿ ಮತ್ತು ಜ್ಞಾನ',
transitMoon:'ಗೋಚಾರ ಚಂದ್ರ',natalMoon:'ಜನ್ಮ ಚಂದ್ರ',moonHouseThemes:'ಚಂದ್ರ ಭಾವ ವಿಷಯಗಳು',
jupNow:'ಗುರು ಈಗ',fromLagna:'ಲಗ್ನದಿಂದ',jupNatal:'ಜನ್ಮ ಗುರು',jupLords:'ಗುರು ಅಧಿಪತ್ಯ',
satNow:'ಶನಿ ಈಗ',fromNatMoon:'ಜನ್ಮ ಚಂದ್ರನಿಂದ',satNatal:'ಜನ್ಮ ಶನಿ',
sadeSatiPhase:'ಸಾಡೆಸಾತಿ ಹಂತ',kantakaShani:'ಕಂಟಕ ಶನಿ',
mahadasha:'ಮಹಾದಶೆ',antardasha:'ಅಂತರ್ದಶೆ',duration:'ಅವಧಿ',
mahaPlanet:'ಮಹಾದಶಾ ಗ್ರಹ',antarPlanet:'ಅಂತರ್ದಶಾ ಗ್ರಹ',
house:'ಭಾವ',houses:'ಭಾವಗಳು',transitNote:'ನಿಮ್ಮ ಜನ್ಮ ಕುಂಡಲಿಯ ಮೇಲೆ ಪ್ರಸ್ತುತ ಗ್ರಹ ಗೋಚಾರದ ಆಧಾರ. ಗೋಚಾರ ಸ್ಥಾನಗಳು ಪ್ರತಿದಿನ ಬದಲಾಗುತ್ತವೆ.',
sunIn:'ಸೂರ್ಯ',saturnIn:'ಶನಿ',jupiter:'ಗುರು',saturn:'ಶನಿ',yogaLabel:'ಯೋಗ'},
te:{analysis:'మీ వ్యక్తిగత విశ్లేషణ',
moonTitle:'చంద్ర గోచారం — భావోద్వేగ వాతావరణం',jupTitle:'గురు గోచారం — విస్తరణ & భాగ్యం',
satTitle:'శని గోచారం — కర్మ & బాధ్యత',dashaTitle:'మీ ప్రస్తుత దశ — గ్రహ కాలం',
wisdomTitle:'మీ అంతర్గత శక్తి & జ్ఞానం',
transitMoon:'గోచర చంద్రుడు',natalMoon:'జన్మ చంద్రుడు',moonHouseThemes:'చంద్ర భావ విషయాలు',
jupNow:'గురు ప్రస్తుతం',fromLagna:'లగ్నం నుండి',jupNatal:'జన్మ గురు',jupLords:'గురు అధిపత్యం',
satNow:'శని ప్రస్తుతం',fromNatMoon:'జన్మ చంద్రుడి నుండి',satNatal:'జన్మ శని',
sadeSatiPhase:'సాడేసాటి దశ',kantakaShani:'కంటక శని',
mahadasha:'మహాదశ',antardasha:'అంతర్దశ',duration:'కాలం',
mahaPlanet:'మహాదశ గ్రహం',antarPlanet:'అంతర్దశ గ్రహం',
house:'భావం',houses:'భావాలు',transitNote:'మీ జన్మ కుండలిపై ప్రస్తుత గ్రహ గోచారం ఆధారంగా. గోచార స్థానాలు ప్రతిరోజు మారతాయి.',
sunIn:'సూర్యుడు',saturnIn:'శని',jupiter:'గురు',saturn:'శని',yogaLabel:'యోగం'},
ta:{analysis:'உங்கள் தனிப்பட்ட பகுப்பாய்வு',
moonTitle:'சந்திர கோச்சாரம் — உணர்வு நிலை',jupTitle:'குரு கோச்சாரம் — விரிவாக்கம் & அதிர்ஷ்டம்',
satTitle:'சனி கோச்சாரம் — கர்மா & பொறுப்பு',dashaTitle:'உங்கள் தற்போதைய தசை — கிரக காலம்',
wisdomTitle:'உங்கள் உள் பலம் & ஞானம்',
transitMoon:'கோச்சார சந்திரன்',natalMoon:'ஜன்ம சந்திரன்',moonHouseThemes:'சந்திர பாவ கருப்பொருள்',
jupNow:'குரு தற்போது',fromLagna:'லக்னத்திலிருந்து',jupNatal:'ஜன்ம குரு',jupLords:'குரு அதிபத்தியம்',
satNow:'சனி தற்போது',fromNatMoon:'ஜன்ம சந்திரனிலிருந்து',satNatal:'ஜன்ம சனி',
sadeSatiPhase:'சாடேசாட்டி கட்டம்',kantakaShani:'கண்டக சனி',
mahadasha:'மகாதசை',antardasha:'அந்தர்தசை',duration:'காலம்',
mahaPlanet:'மகாதசா கிரகம்',antarPlanet:'அந்தர்தசா கிரகம்',
house:'பாவம்',houses:'பாவங்கள்',transitNote:'உங்கள் ஜாதகத்தின் மீதான தற்போதைய கிரக கோச்சாரம் அடிப்படையில். கோச்சார நிலைகள் தினமும் மாறும்.',
sunIn:'சூரியன்',saturnIn:'சனி',jupiter:'குரு',saturn:'சனி',yogaLabel:'யோகம்'},
sa:{analysis:'भवतः व्यक्तिगतं विश्लेषणम्',
moonTitle:'चन्द्रगोचरः — भावनात्मकं वातावरणम्',jupTitle:'गुरुगोचरः — विस्तारः भाग्यं च',
satTitle:'शनिगोचरः — कर्म दायित्वं च',dashaTitle:'भवतः वर्तमानदशा — ग्रहकालः',
wisdomTitle:'भवतः आन्तरिकं बलं ज्ञानं च',
transitMoon:'गोचरचन्द्रः',natalMoon:'जन्मचन्द्रः',moonHouseThemes:'चन्द्रभावविषयाः',
jupNow:'गुरुः अधुना',fromLagna:'लग्नात्',jupNatal:'जन्मगुरुः',jupLords:'गुरुस्वामित्वम्',
satNow:'शनिः अधुना',fromNatMoon:'जन्मचन्द्रात्',satNatal:'जन्मशनिः',
sadeSatiPhase:'साढेसातिचरणम्',kantakaShani:'कण्टकशनिः',
mahadasha:'महादशा',antardasha:'अन्तर्दशा',duration:'अवधिः',
mahaPlanet:'महादशाग्रहः',antarPlanet:'अन्तर्दशाग्रहः',
house:'भावः',houses:'भावाः',transitNote:'भवतः जन्मकुण्डल्यां वर्तमानग्रहगोचराधारितम्। गोचरस्थानानि प्रतिदिनं परिवर्तन्ते।',
sunIn:'सूर्यः',saturnIn:'शनिः',jupiter:'गुरुः',saturn:'शनिः',yogaLabel:'योगः'},
mr:{analysis:'तुमचे वैयक्तिक विश्लेषण',
moonTitle:'चंद्र गोचर — भावनिक वातावरण',jupTitle:'गुरू गोचर — विस्तार आणि भाग्य',
satTitle:'शनी गोचर — कर्म आणि जबाबदारी',dashaTitle:'तुमची सध्याची दशा — ग्रह काळ',
wisdomTitle:'तुमची आंतरिक शक्ती आणि ज्ञान',
transitMoon:'गोचर चंद्र',natalMoon:'जन्म चंद्र',moonHouseThemes:'चंद्र भाव विषय',
jupNow:'गुरू सध्या',fromLagna:'लग्नापासून',jupNatal:'जन्म गुरू',jupLords:'गुरू स्वामित्व',
satNow:'शनी सध्या',fromNatMoon:'जन्म चंद्रापासून',satNatal:'जन्म शनी',
sadeSatiPhase:'साडेसाती टप्पा',kantakaShani:'कंटक शनी',
mahadasha:'महादशा',antardasha:'अंतर्दशा',duration:'कालावधी',
mahaPlanet:'महादशा ग्रह',antarPlanet:'अंतर्दशा ग्रह',
house:'भाव',houses:'भाव',transitNote:'तुमच्या जन्म कुंडलीवर सध्याच्या ग्रह गोचरावर आधारित. गोचर स्थिती दररोज बदलते.',
sunIn:'सूर्य',saturnIn:'शनी',jupiter:'गुरू',saturn:'शनी',yogaLabel:'योग'},
gu:{analysis:'તમારું વ્યક્તિગત વિશ્લેષણ',
moonTitle:'ચંદ્ર ગોચર — ભાવનાત્મક વાતાવરણ',jupTitle:'ગુરુ ગોચર — વિસ્તાર અને ભાગ્ય',
satTitle:'શનિ ગોચર — કર્મ અને જવાબદારી',dashaTitle:'તમારી વર્તમાન દશા — ગ્રહ કાળ',
wisdomTitle:'તમારી આંતરિક શક્તિ અને જ્ઞાન',
transitMoon:'ગોચર ચંદ્ર',natalMoon:'જન્મ ચંદ્ર',moonHouseThemes:'ચંદ્ર ભાવ વિષય',
jupNow:'ગુરુ હાલ',fromLagna:'લગ્નથી',jupNatal:'જન્મ ગુરુ',jupLords:'ગુરુ અધિપત્ય',
satNow:'શનિ હાલ',fromNatMoon:'જન્મ ચંદ્રથી',satNatal:'જન્મ શનિ',
sadeSatiPhase:'સાડેસાટી તબક્કો',kantakaShani:'કંટક શનિ',
mahadasha:'મહાદશા',antardasha:'અંતર્દશા',duration:'સમયગાળો',
mahaPlanet:'મહાદશા ગ્રહ',antarPlanet:'અંતર્દશા ગ્રહ',
house:'ભાવ',houses:'ભાવ',transitNote:'તમારી જન્મ કુંડળી પર વર્તમાન ગ્રહ ગોચરના આધારે. ગોચર સ્થિતિ રોજ બદલાય છે.',
sunIn:'સૂર્ય',saturnIn:'શનિ',jupiter:'ગુરુ',saturn:'શનિ',yogaLabel:'યોગ'},
bn:{analysis:'আপনার ব্যক্তিগত বিশ্লেষণ',
moonTitle:'চন्द्র गोचর — আবেগের আবহাওয়া',jupTitle:'गुरु गोচर — बिস्तार ও भाग्य',
satTitle:'शनि गोচر — कर्म ও दायित्व',dashaTitle:'आपका वर्तमान दशा — ग्रह काल',
wisdomTitle:'आपकी अंतर्गत शक्ति ও ज्ञान',
transitMoon:'गोचर चंद्र',natalMoon:'जन्म चंद्र',moonHouseThemes:'चंद्र भाव विषय',
jupNow:'गुरु अभी',fromLagna:'लग्न से',jupNatal:'जन्म गुरु',jupLords:'गुरु नियंत्रण',
satNow:'शनि अभी',fromNatMoon:'जन्म चंद्र से',satNatal:'जन्म शनि',
sadeSatiPhase:'साढ़े साती अवधि',kantakaShani:'कंटक शनि',
mahadasha:'महादशा',antardasha:'अंतर्दशा',duration:'समयावधि',
mahaPlanet:'महादशा ग्रह',antarPlanet:'अंतर्दशा ग्रह',
house:'भाव',houses:'भाव',transitNote:'आपके जन्म कुंडली पर वर्तमान ग्रह गोचर के आधार पर। गोचर स्थिति हर दिन बदलती है।',
sunIn:'सूर्य',saturnIn:'शनि',jupiter:'गुरु',saturn:'शनि',yogaLabel:'योग'},
ml:{analysis:'നിങ്ങളുടെ വ്യക്തിഗത വിശകലനം',
moonTitle:'ചന്ദ്ര ഗോചരം — വൈകാരിക കാലാവസ്ഥ',jupTitle:'ഗുരു ഗോചരം — വ്യാപ്തി & ഭാഗ്യം',
satTitle:'ശനി ഗോചരം — കർമ്മം & ഉത്തരവാദിത്തം',dashaTitle:'നിങ്ങളുടെ നിലവിലെ ദശ — ഗ്രഹ കാലം',
wisdomTitle:'നിങ്ങളുടെ ആന്തരിക ശക്തി & ജ്ഞാനം',
transitMoon:'ഗോചര ചന്ദ്രൻ',natalMoon:'ജന്മ ചന്ദ്രൻ',moonHouseThemes:'ചന്ദ്ര ഭാവ വിഷയങ്ങൾ',
jupNow:'ഗുരു ഇപ്പോൾ',fromLagna:'ലഗ്നത്തിൽ നിന്ന്',jupNatal:'ജന്മ ഗുരു',jupLords:'ഗുരു അധികാരം',
satNow:'ശനി ഇപ്പോൾ',fromNatMoon:'ജന്മ ചന്ദ്രനിൽ നിന്ന്',satNatal:'ജന്മ ശനി',
sadeSatiPhase:'സാഡേസാതി ഘട്ടം',kantakaShani:'കണ്ടക ശനി',
mahadasha:'മഹാദശ',antardasha:'അന്തർദശ',duration:'കാലാവധി',
mahaPlanet:'മഹാദശാ ഗ്രഹം',antarPlanet:'അന്തർദശാ ഗ്രഹം',
house:'ഭാവം',houses:'ഭാവങ്ങൾ',transitNote:'നിങ്ങളുടെ ജന്മ കുണ്ഡലിയിലെ നിലവിലെ ഗ്രഹ ഗോചരത്തെ അടിസ്ഥാനമാക്കി. ഗോചര സ്ഥാനങ്ങൾ ദിവസവും മാറുന്നു.',
sunIn:'സൂര്യൻ',saturnIn:'ശനി',jupiter:'ഗുരു',saturn:'ശനി',yogaLabel:'യോഗം'}
};
...
function DailyPanchang({ lang }){
    ...
    return (
      <div style={{background:'var(--bg-card)', borderBottom:'1px solid var(--border-light)'}}>
        <div style={{maxWidth:1100, margin:'0 auto', padding:'8px 24px', fontSize:11, color:'var(--text-muted)', display:'flex', flexWrap:'wrap', gap:'8px 16px', alignItems:'center', justifyContent:'center', letterSpacing:0.5}}>
...
function InputForm({onSubmit,lang,setLang}){
  ...
  function submit(e){
    ...
    setTimeout(()=>onSubmit({year,month,day,hour,minute,utcOffset:form.utcOffset,lat:form.lat,lng:form.lng,city:form.city,country:form.country,timezone:form.timezone,gender:form.gender,dob:form.dob,tob:form.tob}),600);
  }
...
function ForecastSection({K,lang='en'}){
  const FC=L_FORECAST[lang]||L_FORECAST.en;
  const GRAHA=L_GRAHA[lang]||L_GRAHA.en;
  const RASHI_N=L_RASHI[lang]||L_RASHI.en;
  const DASHA_M=L_DASHA[lang]||L_DASHA.en;
  const NAKS_N=L_NAKS[lang]||L_NAKS.en;
  const PR=L_PREDICT[lang]||L_PREDICT.en;
  const utcOff=K.input.utcOffset||5.5;
  // Use browser local time for display date (what the user sees on their clock)
  const browserNow=new Date();
  const localYear=browserNow.getFullYear();
  const localMonth=browserNow.getMonth()+1;
  const localDay=browserNow.getDate();
  const localHour=browserNow.getHours();
  const localMin=browserNow.getMinutes();
  const now=browserNow;
  // Transit chart: compute for current astronomical moment at birth location
  const utcH=browserNow.getUTCHours(),utcM=browserNow.getUTCMinutes();
  const todayK=React.useMemo(()=>computeKundali({year:browserNow.getUTCFullYear(),month:browserNow.getUTCMonth()+1,day:browserNow.getUTCDate(),hour:utcH,minute:utcM,utcOffset:0,lat:K.input.lat,lng:K.input.lng}),[]);
  const todayPan=localizePanchang(todayK.panchang,lang);
  const natMoon=K.planets.find(p=>p.key==='moon');
  const natLagna=K.lagna;
  const tMoon=todayK.planets.find(p=>p.key==='moon');
  const tSun=todayK.planets.find(p=>p.key==='sun');
  ...
  const moonQ=[1,3,6,7,10,11].includes(moonFromNat)?'good':moonFromNat===8?'challenging':'moderate';
  const jupFromLagna=((tJup.rashi-natLagna.rashi+12)%12)+1;
  const jupQ=[2,5,7,9,11].includes(jupFromLagna)?'good':[6,8,12].includes(jupFromLagna)?'challenging':'moderate';
  const satFromNat=(tSat.rashi-natMoon.rashi+12)%12;
  const sadePh=satFromNat===11?'rising':satFromNat===0?'peak':satFromNat===1?'setting':null;
  const kantaka=[3,6,9].includes(satFromNat)&&!sadePh;
  const vs=now.getMonth()<3?localYear+56:localYear+57;
  const samvName=SAMVATSARA[(vs-1)%60];
  const hinduMonth=(L_HMONTH[lang]||L_HMONTH.en)[tSun.rashi];
  const curMaha=K.dasha.mahadashas.find(m=>m.isCurrent)||K.dasha.mahadashas[0];
  const curAntar=curMaha?.antars?.find(a=>a.isCurrent)||curMaha?.antars?.[0];
  const mahaName=GRAHA[curMaha?.planet]||curMaha?.planet||'';
  const antarName=GRAHA[curAntar?.planet]||curAntar?.planet||'';
  const fmtD=d=>{const dd=d.getDate(),mm=['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'][d.getMonth()],yy=d.getFullYear();return`${dd} ${mm} ${yy}`;};
  const localDow=now.getDay();
  const weekStart=new Date(now.getFullYear(),now.getMonth(),now.getDate()-localDow);
  const weekEnd=new Date(weekStart.getFullYear(),weekStart.getMonth(),weekStart.getDate()+6);
  const DAYNAMES_EN=['Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday'];
  const vara_en=DAYNAMES_EN[now.getDay()];
  const tMoonName=RASHI_N[tMoon.rashi];
  const natMoonName=RASHI_N[natMoon.rashi];
  const tJupName=RASHI_N[tJup.rashi];
  const tSatName=RASHI_N[tSat.rashi];
  const tSunName=RASHI_N[tSun.rashi];
  const natLagnaName=RASHI_N[natLagna.rashi];
  const todayNak=NAKS_N[todayK.panchang.nakIdx]||todayK.panchang.nakshatra;
  const moonQLabel=FC.moonQ[moonQ];
  const jupQLabel=FC.jupQ[jupQ];
  // Moon day text
  const moonBodyText=moonQ==='good'?(FC.moonD(moonFromNat,tMoonName,natMoonName)+FC.moonGood(moonFromNat)):
    moonQ==='challenging'?(FC.moonD(moonFromNat,tMoonName,natMoonName)+FC.moonChal):
    (FC.moonD(moonFromNat,tMoonName,natMoonName)+FC.moonMod(moonFromNat));
  // Jupiter text
  const jupText=FC.jupDesc[jupQ](jupFromLagna,tJupName);
  // Sade Sati text
  const sadeText=sadePh?FC.sadeSatiDesc[sadePh]:kantaka?FC.kantakaDesc:'';
  // Mahadasha text
  const mahaText=FC.mahaDesc(mahaName,antarName);
  // Year theme
  const yearThemeText=FC.yearTheme(sadePh||kantaka,jupQ);
  const Chip=({label,val,bg='rgba(124, 58, 237, 0.15)',clr='var(--accent-gold)'})=>(
    <div style={{display:'inline-block',background:bg,border:`1px solid ${clr}40`,borderRadius:5,padding:'3px 8px',marginRight:5,marginBottom:5}}>
      <span style={{fontSize:9,color:clr,fontWeight:700,textTransform:'uppercase',letterSpacing:0.5,display:'block'}}>{label}</span>
      <span style={{fontSize:11.5,color:'var(--text-main)',fontWeight:600}}>{val}</span>
    </div>
  );
  const QBadge=({label,good})=>(
    <span style={{display:'inline-block',padding:'2px 10px',borderRadius:10,fontSize:10,fontWeight:700,background:good?'#D1FAE5':'#FEF3C7',color:good?'#065F46':'#92400E',marginLeft:8}}>{label}</span>
  );
  const FCard=({icon,title,period,chips,body,basis,extra,accent='#7C3AED'})=>(
    <div style={{background:'var(--bg-card)',border:'1px solid var(--border-light)',borderRadius:12,padding:'16px 18px',borderTop:`3px solid ${accent}`}}>
      <div style={{display:'flex',alignItems:'center',gap:8,marginBottom:10}}>
        <span style={{fontSize:18}}>{icon}</span>
        <div>
          <p style={{margin:0,fontSize:13,fontWeight:700,color:'var(--text-main)'}}>{title}</p>
          <p style={{margin:0,fontSize:10.5,color:'var(--text-muted)'}}>{period}</p>
        </div>
      </div>
      <div style={{marginBottom:9}}>{chips}</div>
      <p style={{margin:'0 0 8px',fontSize:12.5,color:'var(--text-main)',lineHeight:1.85}}>{body}</p>
      {extra&&<p style={{margin:'0 0 8px',fontSize:12.5,color:'var(--text-main)',lineHeight:1.85}}>{extra}</p>}
      {basis&&<div style={{borderTop:'1px solid var(--border-light)',paddingTop:8,marginTop:4}}>
        <p style={{margin:0,fontSize:11.5,color:'var(--text-muted)',lineHeight:1.7,fontStyle:'italic'}}><strong style={{color:accent,fontStyle:'normal'}}>{FC.basisLabel}:</strong> {basis}</p>
      </div>}
    </div>
  );
  return(
    <div style={{marginTop:18,borderTop:'1px solid var(--border-light)',paddingTop:16}}>
      <h3 style={{margin:'0 0 4px',fontSize:14,color:'var(--text-main)',fontWeight:700,display:'flex',alignItems:'center',gap:6}}>
        <span style={{fontSize:16}}>🔭</span>{FC.heading}
      </h3>
      <p style={{margin:'0 0 13px',fontSize:10.5,color:'var(--text-muted)',fontStyle:'italic'}}>{PR.transitNote}</p>
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:12,marginBottom:12}}>
        <FCard
          icon="☀️" accent="#F59E0B"
          title={FC.today}
          period={`${fmtD(now)} · ${vara_en}`}
          chips={<>
            <Chip label={FC.monthLabel} val={`${hinduMonth} — ${todayPan.tithi}`} bg='var(--bg-badge-orange)' clr='var(--text-badge-orange)'/>
            <Chip label={FC.transitMoon} val={`${tMoonName} · ${todayNak}`} bg='var(--bg-badge-purple)' clr='var(--text-badge-purple)'/>
            <Chip label={PR.yogaLabel} val={todayPan.yoga} bg='var(--bg-badge-green)' clr='var(--text-badge-green)'/>
          </>}
          body={moonBodyText}
          extra={mahaText+(moonQ==='good'?FC.oppLabel+': '+DASHA_M[curMaha?.planet]||'':'')}
          basis={`${moonQLabel}. ${DASHA_M[curMaha?.planet]||''}`}
        />
        <FCard
          icon="🌙" accent="#8B5CF6"
          title={FC.week}
          period={`${fmtD(weekStart)} – ${fmtD(weekEnd)}`}
          chips={<>
            <Chip label={PR.sunIn} val={tSunName} bg='var(--bg-badge-orange)' clr='var(--text-badge-orange)'/>
            <Chip label={PR.saturnIn} val={tSatName} bg='var(--bg-badge-neutral)' clr='var(--text-badge-neutral)'/>
            <Chip label={FC.transitMoon} val={tMoonName} bg='var(--bg-badge-purple)' clr='var(--text-badge-purple)'/>
          </>}
          body={sadePh||kantaka?sadeText:jupText}
          extra={`${mahaText}${FC.week}: ${DASHA_M[curAntar?.planet]||DASHA_M[curMaha?.planet]||''}`}
          basis={`${jupQLabel}. ${sadePh?FC.sadeSati[sadePh]:kantaka?FC.kantaka:''}`}
        />
      </div>
      <FCard
        icon="🪐" accent="#1E3A5F"
        title={FC.year}
        period={`${vs} ${samvName} · ${localYear}`}
        chips={<>
          <Chip label={FC.vsLabel} val={`${vs} — ${samvName}`} bg='var(--bg-badge-neutral)' clr='var(--text-badge-neutral)'/>
          <Chip label={PR.jupiter} val={`${tJupName} · H${jupFromLagna}`} bg='var(--bg-badge-orange)' clr='var(--text-badge-orange)'/>
          <Chip label={PR.saturn} val={`${tSatName}${sadePh?' · '+FC.sadeSati[sadePh]:kantaka?' · '+FC.kantaka:''}`} bg='var(--bg-badge-neutral)' clr='var(--text-badge-neutral)'/>
          <Chip label={PR.mahadasha} val={`${mahaName}${antarName?' / '+antarName:''}`} bg='var(--bg-badge-purple)' clr='var(--text-badge-purple)'/>
        </>}
        body={jupText}
        extra={(sadePh||kantaka?sadeText+' ':'')+yearThemeText}
        basis={`${mahaText}${jupQLabel}. ${DASHA_M[curMaha?.planet]||''}`}
      />
    </div>
  );
}

function PredictionsTab({K,lang='en'}){
  const FC=L_FORECAST[lang]||L_FORECAST.en;
  const GRAHA=L_GRAHA[lang]||L_GRAHA.en;
  const RASHI_N=L_RASHI[lang]||L_RASHI.en;
  const DASHA_M=L_DASHA[lang]||L_DASHA.en;
  ...
  const natMoon=K.planets.find(p=>p.key==='moon');
  const natLagna=K.lagna;
  const natSun=K.planets.find(p=>p.key==='sun');
  const natJup=K.planets.find(p=>p.key==='jupiter');
  const natSat=K.planets.find(p=>p.key==='saturn');
  const cur=K.dasha.mahadashas.find(m=>m.isCurrent)||K.dasha.mahadashas[0];
  const curA=cur?.antars?.find(a=>a.isCurrent)||cur?.antars?.[0];
  // Transit computation (same as ForecastSection)
  const browserNow=new Date();
  const utcH=browserNow.getUTCHours(),utcM=browserNow.getUTCMinutes();
  const todayK=React.useMemo(()=>computeKundali({year:browserNow.getUTCFullYear(),month:browserNow.getUTCMonth()+1,day:browserNow.getUTCDate(),hour:utcH,minute:utcM,utcOffset:0,lat:K.input.lat,lng:K.input.lng}),[]);
  const tMoon=todayK.planets.find(p=>p.key==='moon');
  ...
  const sadePh=satFromNat===11?'rising':satFromNat===0?'peak':satFromNat===1?'setting':null;
  const kantaka=[3,6,9].includes(satFromNat)&&!sadePh;
  const mahaName=GRAHA[cur?.planet]||cur?.planet||'';
  const antarName=GRAHA[curA?.planet]||curA?.planet||'';
  const tMoonName=RASHI_N[tMoon.rashi];
  const natMoonName=RASHI_N[natMoon.rashi];
  const tJupName=RASHI_N[tJup.rashi];
  const tSatName=RASHI_N[tSat.rashi];
  ...
  // Moon transit house descriptions (12 houses from natal Moon)
  const XP=L_EXT_PRED[lang]||L_EXT_PRED.en;
  const MD=L_MOON_DESC[lang]||L_MOON_DESC.en;

  const Chip=({label,val,bg='#F5F0FF',clr='#7C3AED'})=>(
    <div style={{display:'inline-block',background:bg,border:`1px solid ${clr}22`,borderRadius:5,padding:'3px 8px',marginRight:5,marginBottom:5}}>
      <span style={{fontSize:9,color:clr,fontWeight:700,textTransform:'uppercase',letterSpacing:0.5,display:'block'}}>{label}</span>
      <span style={{fontSize:11.5,color:'var(--text-main)',fontWeight:600}}>{val}</span>
    </div>
  );
  ...
  const tSun=todayK.planets.find(p=>p.key==='sun');
  const tSunName=RASHI_N[tSun.rashi];
  const mahaPlanet=K.planets.find(p=>p.key===cur?.planet);
  const antarPlanet=K.planets.find(p=>p.key===curA?.planet);
  const mahaNakIdx=mahaPlanet?.nIdx;
  const antarNakIdx=antarPlanet?.nIdx;
  const jupRulesH=housesRuled('jupiter',natLagna.rashi);
  const satRulesH=housesRuled('saturn',natLagna.rashi);
  const mahaHouses=jupRulesH.includes(cur?.planet)||satRulesH.includes(cur?.planet)?'critical':natSun.rashi===mahaPlanet?.rashi?'conjunction':'transit';
  const satFromMoon=(tSat.rashi-natMoon.rashi+12)%12;

  return(
    <div style={{animation:'slideIn 0.2s ease'}}>
      <ForecastSection K={K} lang={lang}/>

      <div style={{marginTop:22,borderTop:'1px solid var(--border-light)',paddingTop:18}}>
        <h3 style={{margin:'0 0 14px',fontSize:14,color:'var(--text-main)',fontWeight:700,display:'flex',alignItems:'center',gap:6}}>
          <span style={{fontSize:16}}>🌙</span>{PR.analysis}
        </h3>
        ...
        <Card style={{marginBottom:14}} left="#8B5CF6">
          ...
          <p style={{margin:'8px 0 0',fontSize:12.5,color:'var(--text-muted)',lineHeight:1.85,fontStyle:'italic'}}>{XP.m_foot}</p>
        </Card>
        ...
        <Card style={{marginBottom:14}} left="#F59E0B">
          ...
          <p style={{margin:'8px 0 0',fontSize:12.5,color:'var(--text-main)',lineHeight:1.85}}>
            {XP.jrules(jupRulesH.includes(9)||jupRulesH.includes(12)?(jupRulesH.join(', ')):(jupRulesH.join(', ')))}{' '}
            {jupRulesH.includes(9)?XP.j_h9:''}{jupRulesH.includes(12)?XP.j_h12:''}
            {[2,5,7,11].includes(jupFromLagna)?XP.j_fort:XP.j_ref}
          </p>
          <p style={{margin:'8px 0 0',fontSize:12.5,color:'var(--text-muted)',lineHeight:1.85,fontStyle:'italic'}}>{XP.j_foot}</p>
        </Card>
        ...
        <Card style={{marginBottom:14}} left="#475569">
          ...
          <p style={{margin:'12px 0 0',fontSize:12.5,color:'var(--text-main)',lineHeight:1.85}}>
            ...
            {sadePh?(sadePh==='rising'?XP.s_sade_r:sadePh==='peak'?XP.s_sade_p:XP.s_sade_s):
              kantaka?XP.s_kan:
              XP.s_base(tSatName, RASHI_N[natSat.rashi]||'', natSat.house)}
          </p>
          <p style={{margin:'8px 0 0',fontSize:12.5,color:'var(--text-main)',lineHeight:1.85}}>
            {XP.srules(satRulesH.join(', '))} {satRulesH.includes(10)?XP.s_h10:''}{satRulesH.includes(11)?XP.s_h11:''}{satRulesH.includes(6)?XP.s_h6:''}{XP.s_build}
          </p>
          <p style={{margin:'8px 0 0',fontSize:12.5,color:'var(--text-muted)',lineHeight:1.85,fontStyle:'italic'}}>{XP.s_foot}</p>
        </Card>

        <Card style={{marginBottom:14}} left="#7C3AED">
          <h4 style={{margin:'0 0 10px',fontSize:13,color:'var(--accent-gold)',fontWeight:700}}>{PR.dashaTitle}</h4>
          <Chip label={PR.mahadasha} val={mahaName} bg='var(--bg-badge-purple)' clr='var(--text-badge-purple)'/>
          <Chip label={PR.antardasha} val={antarName} bg='var(--bg-badge-orange)' clr='var(--text-badge-orange)'/>
          <Chip label={PR.duration} val={`${cur?.startStr} – ${cur?.endStr}`} bg='var(--bg-badge-purple)' clr='var(--text-badge-purple)'/>
          <Chip label={PR.mahaPlanet} val={`${RASHI_N[mahaPlanet?.rashi]} (H${mahaPlanet?.house})`} bg='var(--bg-badge-purple)' clr='var(--text-badge-purple)'/>
          {antarPlanet&&<Chip label={PR.antarPlanet} val={`${RASHI_N[antarPlanet?.rashi]} (H${antarPlanet?.house})`} bg='var(--bg-badge-orange)' clr='var(--text-badge-orange)'/>}
          <p style={{margin:'12px 0 0',fontSize:12.5,color:'var(--text-main)',lineHeight:1.85}}>
            {XP.dasha(mahaName, RASHI_N[mahaPlanet?.rashi]||'', mahaPlanet?.house||'', mahaPlanet?.exalted?'exalted':mahaPlanet?.debil?'debilitated':'placed')}{' '}
            {mahaPlanet?XP.drules(housesRuled(cur?.planet,natLagna.rashi).join(', ')):''}{' '}
            {XP.antar(antarName, RASHI_N[antarPlanet?.rashi]||'', antarPlanet?.house||'', antarPlanet?.exalted?'strengthened':'challenged')}{' '}
            {XP.d_rel}
          </p>
          <p style={{margin:'8px 0 0',fontSize:12.5,color:'var(--text-main)',lineHeight:1.85}}>
            {XP.d_cyc}
          </p>
          <p style={{margin:'8px 0 0',fontSize:12.5,color:'var(--text-muted)',lineHeight:1.85,fontStyle:'italic'}}>{XP.d_wind}</p>
        </Card>

        <Card left="#16A34A">
          <h4 style={{margin:'0 0 10px',fontSize:13,color:'#16A34A',fontWeight:700}}>{PR.wisdomTitle}</h4>
          <p style={{margin:'12px 0 0',fontSize:12.5,color:'var(--text-main)',lineHeight:1.85}}>{XP.w1}</p>
          <p style={{margin:'8px 0 0',fontSize:12.5,color:'var(--text-main)',lineHeight:1.85}}>{XP.w2}</p>
          <p style={{margin:'8px 0 0',fontSize:12.5,color:'var(--text-main)',lineHeight:1.85}}>{XP.w3}</p>
          <p style={{margin:'8px 0 0',fontSize:12.5,color:'var(--text-muted)',lineHeight:1.85,fontStyle:'italic'}}><strong style={{color:'#16A34A',fontStyle:'normal'}}>{XP.w4?.split(':')[0]||''}:</strong> {XP.w4?.split(':').slice(1).join(':')||XP.w4||''}</p>
        </Card>
      </div>
    </div>
  );
...
function OverviewTab({K,fmt,lang='en'}){
  ...
  return(
    <div style={{animation:'slideIn 0.2s ease'}}>
      <Card left="#7C3AED" style={{marginBottom:14}}>
        <h3 style={{margin:'0 0 10px',fontSize:13,color:'var(--accent-gold)',fontWeight:700}}>{t('ov.title',lang)}</h3>
        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fill,minmax(180px,1fr))',gap:'7px 14px',fontSize:13}}>
          {[[t('ov.sunrise',lang),sunrise],[t('ov.sunset',lang),sunset],[t('ov.lst',lang),lst],[t('ov.ayanamsa',lang),ayanamsaDMS],[t('ov.tithi',lang),lpan.tithi],[t('ov.vara',lang),lpan.vara],[t('ov.nakshatra',lang),lpan.nakshatra],[t('ov.yoga',lang),lpan.yoga],[t('ov.karana',lang),lpan.karana]].map(([k,v])=>(
            <div key={k}><span style={{fontSize:10,color:'var(--text-muted)',fontWeight:600,textTransform:'uppercase',letterSpacing:0.5,display:'block'}}>{k}</span><span style={{color:'var(--text-main)',fontWeight:500}}>{v}</span></div>
          ))}
        </div>
      </Card>
    ...
    <div style={{minHeight:'100vh',background:'var(--bg-dark)'}}>
      ...
      <div style={{maxWidth:1100,margin:'0 auto',padding:'40px 24px 80px'}}>
        ...
        <div style={{ marginBottom: 60, padding: '24px', background: 'var(--bg-surface)', borderRadius: '12px', border: '1px solid var(--border-light)' }}>
          ...
          {partnerKundali && (
            <CompatibilityMatch primaryKundali={K} partnerKundali={partnerKundali} lang={lang} t={t} />
          )}
        </div>
...
function AppHeader({ lang, setLang }) {
  ...
  return (
      <header className="app-header" style={{borderBottom:'1px solid var(--border-light)',background:'var(--bg-surface)',backdropFilter:'blur(12px)',position:'sticky',top:0,zIndex:20}}>
        <div style={{maxWidth:1100, margin:'0 auto', display:'flex',justifyContent:'space-between',alignItems:'center',padding:'12px 32px'}}>
          <div style={{display:'flex',alignItems:'center',gap:14}}>
            <div style={{width:40,height:40,background:'transparent',border:'1px solid var(--accent-gold)',borderRadius:'50%',display:'flex',alignItems:'center',justifyContent:'center',boxShadow:'0 0 12px var(--accent-glow)'}}>
...
function App(){
  ...
  function handleSubmit(inp){
    try{setErr(null);setKundali(computeKundali(inp));setScreen('results')}
  ...
  if(err)return<div style={{minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center',background:'var(--bg-app)',fontFamily:'serif'}}><div style={{background:'var(--bg-card)',borderRadius:12,padding:28,maxWidth:400,border:'1px solid var(--border-light)',textAlign:'center'}}><p style={{fontSize:32,margin:'0 0 10px'}}>⚠️</p><p style={{color:'var(--text-main)',fontSize:14,marginBottom:14}}>{err}</p><button onClick={()=>setErr(null)} style={{padding:'9px 22px',borderRadius:8,border:'none',background:'var(--accent-gold)',color:'#000',cursor:'pointer',fontFamily:'inherit',fontSize:14}}><strong>{t('tryAgain',lang)}</strong></button></div></div>;
    ...
    return (
      <div style={{minHeight:'100vh'}}>
        ...
        {screen==='results'&&kundali ? <ResultsPage K={kundali} onBack={goBack} lang={lang} /> : <InputForm onSubmit={handleSubmit} lang={lang} />}
      </div>
    );
  }
