    ...
    <div style={{minHeight:'100vh',background:'var(--bg-dark)'}}>
      ...
      <div style={{background:'var(--bg-header-gradient)',borderBottom:'1px solid var(--border-light)',padding:'30px 40px'}}>
        <div style={{maxWidth:1100,margin:'0 auto'}}>
          <h2 className="serif" style={{margin:'0 0 12px',fontSize:24,fontWeight:400,color:'var(--accent-gold)',letterSpacing:1.5}}>{t('inputTitle',lang)} — {lpan.nakshatra}</h2>
      ...
      <div style={{maxWidth:1100,margin:'0 auto',padding:'40px 24px 80px'}}>
        ...
        <div style={{ marginBottom: 60, padding: '24px', background: 'var(--bg-surface)', borderRadius: '12px', border: '1px solid var(--border-light)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <h2 className="serif" style={{color:'var(--text-main)', margin: 0}}>💞 {t('headers.compatibility', lang)}</h2>
          ...
          }} onCancel={() => setShowPartnerForm(false)} lang={lang} t={t} />
          )}
          {partnerKundali && (
        ...
        <div>
          <h2 className="serif" style={{color:'var(--text-main)', borderBottom:'1px solid var(--border-light)', paddingBottom:'12px', marginBottom: '24px'}}>⌬ {t('headers.desk', lang)}</h2>
