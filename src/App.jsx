  ...
  return(
    <div style={{minHeight:'100vh'}}>
      ...
      <footer className="no-print" style={{textAlign:'center',padding:'24px',marginTop:'auto'}}>
        <button onClick={onOpenTerms} type="button" style={{background:'none',border:'none',color:'var(--text-muted)',textDecoration:'underline',cursor:'pointer',fontSize:12,fontFamily:'inherit',transition:'color 0.2s'}} onMouseOver={e=>e.currentTarget.style.color='var(--accent-gold)'} onMouseOut={e=>e.currentTarget.style.color='var(--text-muted)'}>Terms of Service</button>
      </footer>
    </div>
  );
}
...
function TermsModal({ onClose }) {
  const G = 'var(--accent-gold)', M = 'var(--text-main)', D = 'var(--text-muted)';
  return (
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.8)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100000, animation: 'fadeIn 0.2s ease-out' }}>
       <div style={{ background: 'var(--bg-card)', padding: '32px', border: '2px solid var(--border-light)', borderRadius: '8px', maxWidth: '800px', width: '90%', maxHeight: '85vh', overflowY: 'auto', position: 'relative', boxShadow: '0 20px 50px rgba(0,0,0,0.5)' }}>
          <button onClick={onClose} style={{ position: 'absolute', top: 20, right: 20, background: 'transparent', border: 'none', color: D, fontSize: 24, cursor: 'pointer', transition: 'color 0.2s' }} onMouseOver={e=>e.currentTarget.style.color=G} onMouseOut={e=>e.currentTarget.style.color=D}>✕</button>
          
          <h2 style={{ color: G, fontFamily: '"Cinzel", serif', marginBottom: '8px', fontSize: 28 }}>Terms of Service</h2>
          <p style={{ color: D, marginBottom: '24px', fontSize: '13px' }}><strong>Last Updated:</strong> March 27, 2026</p>

          <div style={{ color: M, fontSize: '15px', lineHeight: 1.6, fontFamily: 'serif' }}>
            <p style={{ marginBottom: '16px' }}>Welcome to Jyotish Darshan (accessible via <a href="https://preview.jyotishdarshan.org/" target="_blank" rel="noreferrer" style={{ color: G }}>https://preview.jyotishdarshan.org/</a>). By accessing or using our website, software, or services (collectively, the "Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use the Service.</p>

            <h3 style={{ color: G, marginTop: '24px', marginBottom: '12px', fontSize: 20 }}>1. Purpose of the Service</h3>
            <p style={{ marginBottom: '16px' }}>The Service is provided strictly for the purposes of education, learning, research, and entertainment ("fun"). It is designed to offer astrological calculations and related content, but it is not intended to provide actionable advice or direct life guidance.</p>

            <h3 style={{ color: G, marginTop: '24px', marginBottom: '12px', fontSize: 20 }}>2. No Warranties or Claims of Accuracy</h3>
            <p style={{ marginBottom: '8px' }}>You expressly understand and agree that your use of the Service is at your sole risk. The Service is provided on an "AS IS" and "AS AVAILABLE" basis.</p>
            <ul style={{ paddingLeft: '24px', marginBottom: '16px' }}>
              <li style={{ marginBottom: '8px' }}><strong>Predictions & Calculations:</strong> We make no claims, representations, or warranties regarding the accuracy, reliability, or completeness of any astrological predictions, panchang data, planetary positions, or the movement of celestial bodies.</li>
              <li style={{ marginBottom: '8px' }}><strong>Consistency:</strong> There is no commitment or guarantee that the Service will yield consistent predictions or identical outputs for the same data inputs over time.</li>
              <li><strong>Life Events:</strong> We expressly disclaim any assertions that the celestial alignments or astrological reports generated by this Service have any guaranteed implications on real-life events, past, present, or future.</li>
            </ul>

            <h3 style={{ color: G, marginTop: '24px', marginBottom: '12px', fontSize: 20 }}>3. Not a Substitute for Professional Advice</h3>
            <p style={{ marginBottom: '16px' }}>This software and the content provided herein are not an alternative to, nor a substitute for, the services of a professional, expert astrologer, psychic, therapist, medical professional, financial advisor, or legal counsel. If you require specific advice or guidance, you are strongly encouraged to consult a qualified expert in the relevant field.</p>

            <h3 style={{ color: G, marginTop: '24px', marginBottom: '12px', fontSize: 20 }}>4. Limitation of Liability</h3>
            <p style={{ marginBottom: '8px' }}>Under no circumstances shall the creators, developers, owners, or affiliates of this Service be held liable for any direct, indirect, incidental, consequential, special, or exemplary damages arising out of or in connection with your use of the Service.</p>
            <ul style={{ paddingLeft: '24px', marginBottom: '16px' }}>
              <li style={{ marginBottom: '8px' }}><strong>User Actions:</strong> We accept no responsibility or liability for any decisions made, actions taken, or not taken by you or anyone else based on the predictions, compatibility reports, or any other information provided by the Service.</li>
              <li><strong>Use at Own Discretion:</strong> You acknowledge that any reliance upon any information obtained through the Service is strictly at your own discretion and risk.</li>
            </ul>

            <h3 style={{ color: G, marginTop: '24px', marginBottom: '12px', fontSize: 20 }}>5. Privacy and Information Security</h3>
            <p style={{ marginBottom: '16px' }}>By using this Service, you acknowledge and agree that there is no commitment to the privacy, confidentiality, or security of any information, data, or personal details you voluntarily share, upload, or input into the Service. Any information you provide is submitted entirely at your own risk, and you waive any claims related to the unauthorized access, disclosure, or use of such data.</p>

            <h3 style={{ color: G, marginTop: '24px', marginBottom: '12px', fontSize: 20 }}>6. User Conduct and Acknowledgment</h3>
            <p style={{ marginBottom: '16px' }}>By utilizing the Service, you acknowledge that astrology is not an exact science and is subject to varied interpretations. You agree to use the Service reasonably and responsibly, keeping in mind its foundational purpose of education, research, and entertainment.</p>

            <h3 style={{ color: G, marginTop: '24px', marginBottom: '12px', fontSize: 20 }}>7. Modifications to Terms</h3>
            <p style={{ marginBottom: '16px' }}>We reserve the right to modify or replace these Terms at any time without prior notice. Your continued use of the Service after any changes to these Terms constitutes your acceptance of the new Terms.</p>

            <h3 style={{ color: G, marginTop: '24px', marginBottom: '12px', fontSize: 20 }}>8. Contact Information</h3>
            <p style={{ marginBottom: '16px' }}>If you have any questions about these Terms, please contact the site administrator as provided on the website.</p>

            <p style={{ fontStyle: 'italic', color: D, marginTop: '32px' }}>By continuing to use <a href="https://preview.jyotishdarshan.org/" target="_blank" rel="noreferrer" style={{ color: G }}>https://preview.jyotishdarshan.org/</a>, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.</p>
          </div>
       </div>
    </div>
  );
...
function ResultsPage({K,onBack,lang,onSwitchProfile,user,onRequireLogin,onForceSync,onOpenTerms}){
  ...
  return(
    <div style={{minHeight:'100vh',background:'var(--bg-dark)'}}>
      ...
      <footer className="no-print" style={{textAlign:'center',padding:'24px',borderTop:'1px solid var(--border-light)',background:'var(--bg-dark)'}}>
        ...
        <button onClick={onOpenTerms} style={{background:'none',border:'none',color:'var(--accent-gold)',textDecoration:'underline',cursor:'pointer',fontSize:12,fontFamily:'inherit',marginTop:12}}>Terms of Service</button>
      </footer>
    </div>
  );
}
...
function App(){
  ...
  return (
    <div style={{minHeight:'100vh', display:'flex', flexDirection:'column'}}>
      ...
      {screen==='results'&&kundali ? <ResultsPage K={kundali} onBack={goBack} lang={lang} onSwitchProfile={handleSubmit} user={user} onRequireLogin={() => setShowAuthModal(true)} onForceSync={handleForceSync} onOpenTerms={() => setShowTerms(true)} /> : <InputForm onSubmit={handleSubmit} lang={lang} onOpenTerms={() => setShowTerms(true)} />}
    </div>
  );
}
